				...
				<div class="header_top_area">
					<div class="tl_top_menu top_left_menu">
						<ul>
							...
							<li><a href="myorder.php" class="fa fa-list" style="margin-left:200px;"><i  aria-hidden="true"></i>My order</a></li>
					...
					<div class="tl_top_menu top_right_menu">
						<ul>	
							<?php } ?>
							<li><a href="faq.php" class="fa fa-question-circle" style="margin-left:200px;" ><i  aria-hidden="true"></i>FAQ</a></li>
							<li><a href="how_work.php" style="margin-right:100px;"><i  aria-hidden="true"></i>How it works?</a></li>
						</ul>
					</div>
				</div>
					...
					<div class="header_right_menu">
								...
								<li>
									...
									<ul class="sub-menu">
										<?php 
											...
											{
										?>
										<li><a href="womens.php?cat_id=<?php echo $result_cat['category_id'];?>&category_type=<?php echo $result_cat['category_type'];?>"><?php echo $result_cat['category_name'];?></a></li>
										<?php } ?>
									</ul>
								</li>
								<li>
						...
						<nav class="menu_section right_nav">
							<ul class="menu"> 
				                ...
				                ?>
				              	<a class="nav-link px-xl-4 text-gigas" id="navbarShop" href="login.php" style="margin-right:200px;" >Login/Register</a>
				               	<?php } ?>
				                ...
				                <li class="nav-item dropdown">
									...
									?>
				                    Welcome <?php echo $result['customer_name'];  ?>
				                    ...
				                    <ul class="sub-menu">
				                        <li><?php 
											...
											?>
				                            <a class="dropdown-link" href="profile.php?my_id=<?php echo $result['customer_id'];?>">
				                                My Profile                                    
				                            </a>
