...
<div class="main_section section_08">
	<div class="container">
		<div class="row">
			<div class="col-md-8 col-sm-12 col-xs-12 blog_main">
				<div class="row">
					<div class="blog_main">
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								<span class="blog_date">
									...
									<div class="bog_m">Jan 2018</div>
								 </span>
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_1.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
									<p class="fashion_tag">#Fashion</p>
									<h3>Video Monitoring Surveillan</h3>
									<div class="blog_meta">
										<span><i class="fa fa-user-o"></i>Admin</span> 
										<span><i class="fa fa-comment-o" aria-hidden="true"></i>comments</span>
									</div>
									<p>
										Li Europan lingues es membres del e family separat existentie scientie, lit emusica, sport sam vocabular.
									</p>
									<div class="btn_box">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								<span class="blog_date">
									<div class="blog_d">28</div>
									<div class="bog_m">Jan 2018</div>
								 </span>
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_2.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
									<p class="fashion_tag">#Design</p>
									<h3>Video Monitoring Surveillan</h3>
									<div class="blog_meta">
										<span><i class="fa fa-user-o"></i>Admin</span> 
										<span><i class="fa fa-comment-o" aria-hidden="true"></i>comments</span>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								<span class="blog_date">
									<div class="blog_d">20</div>
									<div class="bog_m">Jan 2018</div>
								 </span>
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_3.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
									<p class="fashion_tag">#Tailor</p>
									<h3>Video Monitoring Surveillan</h3>
									<div class="blog_meta">
										<span><i class="fa fa-user-o"></i>Admin</span> 
										<span><i class="fa fa-comment-o" aria-hidden="true"></i>comments</span>
						...
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								...
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_4.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								...
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_5.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
						...
						<div class="col-md-6 col-sm-6 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
							<div class="blog_box">
								...
								<!-- thumb -->
								<div class="blog_thumb blog_imgafter">
									<img src="images/blog/blog_6.jpg" alt="image" class="img-responsive">
								</div>
								<!-- thumb -->
								<!-- Description -->
								<div class="blog_desc home">
