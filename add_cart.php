...
if(isset($_POST['lining_id']) || isset($_POST['tassels_id']) || isset($_POST['cups_id']) || isset($_POST['piping_id']) || isset($_POST['work_id']))
{
	...
	$tassels_id=$_POST['tassels_id'] ? $_POST['tassels_id'] : 'NULL';
	$cups_id=$_POST['cups_id'] ? $_POST['cups_id'] : 'NULL';
	$piping_id=$_POST['piping_id'] ? $_POST['piping_id'] : 'NULL';
	$work_id=$_POST['work_id'] ? $_POST['work_id'] : 'NULL';
	$cat_id=$_POST['cat_id'];
...
echo '<script type="text/javascript">';
echo 'window.location.href="womens.php?cat_id='.$_SESSION['cat_id'].'&sub_cat_id='.$_SESSION['sub_cat_id'].'&category_type='.$_GET['category_type'].'"';
echo '</script>';
