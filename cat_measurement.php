...
if (isset($_POST['sbtn'])) {
    ...
    if ($data['category_type'] == 'top and bottom') {
        $blouse_str = "insert into bt_measurement_tbl values(NULL,'" . $cat_id . "','" . $_POST['height'] . "','" . $_POST['blength'] . "','" . $_POST['shoulder'] . "','" . $_POST['bust'] . "','" . $_POST['waist'] . "','" . $_POST['arm_hole'] . "','" . $_POST['slength'] . "','" . $_POST['loose'] . "','" . $_POST['frontneck'] . "','" . $_POST['backneck'] . "')";
        mysqli_query($cnn, $blouse_str);
        #update cart set measurements
        $last_id = mysqli_insert_id($cnn);
        if ($last_id) {
            $update_cart = "update cart_tbl set bt_id='" . $last_id . "' where 
                category_id='" . $_GET['cat_id'] . "'  and customer_id='" . $_SESSION['uid'] . "' and cart_status=0";
            //echo $update_cart;die;
            mysqli_query($cnn, $update_cart);
            echo '<script type="text/javascript">';
                        ...
                        <div class="row">
                            <form id="custom_val" method="POST">
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="height" id="height" class="input form-control require"
                                        placeholder="Top height">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="length" id="length" class="input form-control require"
                                        placeholder=" Top length*">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="shoulder" id="shoulder"
                                        class="input form-control require" placeholder="Top shoulder*">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="bust" id="bust" placeholder=" Top bust"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="waist" id="waist" placeholder=" Top waist"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="arm_hole" id="arm_hole" placeholder=" Top arm hole"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="slength" id="slength" placeholder=" Top Sleeve length"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="loose" id="loose" placeholder=" Top sleeve loose"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="hip_round" id="hip_round" placeholder=" Top hip round"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="frontneck" id="frontneck"
                                        placeholder=" Top frontneck deep" class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="backneck" id="backneck"
                                        placeholder=" Top backneck deep" class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="surround" id="surround" placeholder=" Top surround"
                                        class="form-control require">
                                </div>
                    ...
                    <div class="contact_form cntct">
                        <div class="row">
                            <form id="custom_val" method="POST">
                                ...
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="blength" id="blength"
                                        class="input form-control require" placeholder="Shoulder">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="shoulder" id="shoulder"
                                        class="input form-control require" placeholder="Chest">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="bust" id="bust" placeholder="Stomach"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="waist" id="waist" placeholder="Hips"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="arm_hole" id="arm_hole" placeholder="Sleeve Length"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="slength" id="slength"
                                        placeholder="Length" class="form-control require">
                                </div>
                                <!-- <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="loose" id="loose" placeholder=" Blouse loose"
                                        class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="frontneck" id="frontneck"
                                        placeholder=" Blouse frontneck" class="form-control require">
                                </div>
                                <div class="col-md-6 col-xs-12 form_group">
                                    <input type="text" required name="backneck" id="backneck" placeholder=" Blouse backneck"
                                        class="form-control require">
                                </div>-->
                                <div class="col-sm-12 col-xs-12">
                                    <input type="submit" class="btn btn-primary" name="sbtn" value="Submit">
                    ...
                    <div class="contact_form_wrap">
                        ...
                        <div class="contact_form cntct">
                            <div class="row">
                                <form id="custom_val" method="POST">
                                    <div class="col-md-6 col-xs-12 form_group">
                                        <input type="text" required name="waist" id="waist"
                                            class="input form-control require" placeholder="Kurta Pajama waist">
                                    </div>
                                    <div class="col-md-6 col-xs-12 form_group">
                                        <input type="text" required name="round" id="round"
                                            class="input form-control require" placeholder="Waist" placeholder="Hip">
                                    </div>
                                    <div class="col-md-6 col-xs-12 form_group">
                                        <input type="text" required name="thigh" id="thigh"
                                            class="input form-control require" placeholder="Shoulder">
                                    </div>
                                    <div class="col-md-6 col-xs-12 form_group">
                                        <input type="text" required name="ankleround" id="ankleround" placeholder="Sleeve"
                                            class="form-control require">
                                    </div>
                                    <div class="col-md-6 col-xs-12 form_group">
                                        <input type="text" required name="btmlength" id="btmlength"
                                            placeholder="Pant length" class="form-control require">
                                    </div>
                                    <div class="col-sm-12 col-xs-12">
                                        <input type="submit" class="btn btn-primary" name="sbtn" value="Submit">
                                        <div class="response"></div>
