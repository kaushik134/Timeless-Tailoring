...
<head>
  ...
  <?php  
        if(isset($_POST['sub']))
        {  
          $str="select * from admin_tbl where admin_email='".$_POST['admin_email']."' and password='".$_POST['password']."'";
          //echo $str;die;
                    ...
                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                        <div class="card-header pb-1">
                            <div class="card-title">
                                <h4 class="text-center mb-2">Welcome To TimelessTailoring </h4>
                            </div>
                        </div>
                            ...
                            <form method="POST" id="custom_val">
                                <div class="form-group mb-50">
                                    ...
                                    <input type="email" class="form-control" id="exampleInputEmail1"
                                        placeholder="Email address" name="admin_email" required=""></div>
                                ...
                                <div
                                    ...
                                    <div class="text-right"><a href="forgat_password.php"
                                            class="card-link"><small>Forget Password?</small></a></div>
                                </div>
                                <input type="submit" name="sub" value="LogIn" class="btn btn-primary glow w-100 position-relative">
                                <!-- Login<i id="icon-arrow" class="bx bx-right-arrow-alt"></i></button> -->
                            </form>
                            <hr>
