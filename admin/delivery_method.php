...
<head>
    ...
    <title>Delivery method List | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
              			  <?php 
                      $qry="select * from delivery_method_tbl,order_tbl where delivery_method_tbl.order_id=order_tbl.order_id";
              				$test=mysqli_query($cnn,$qry);
              				while($result=mysqli_fetch_array($test))
              				{
              					?>
                          <tr>
                            <td><button type="button" style="" id="order" class="btn" data-id="<?php echo $result['order_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                                  <div class="fonticon-wrap">
                                            <i class="bx bx-folder-open"></i>
                                        </div> <?php //echo getCustomerName($result['customer_id']);?> 
                                  </button><?php echo $result['order_id'];?></td> 
                  				  <td><?php echo $result['submitted_date'];?></td>
                            <td><?php echo $result['price'];?></td>
                            <td>
                              <?php if($result['status']==0) { ?>
                                                   
                                                   <a href="change_status.php?delivery_method_id=<?php echo $result['delivery_method_id'];?>&status=<?php echo $result['status'];?>"> 
                                                   <div class="fonticon-wrap">
