...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $qry1="select * from tassels_tbl";
  $result=mysqli_query($cnn,$qry1);
  $tname=$price=$img='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from tassels_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from tassels_tbl where tassels_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $tname=$res['tassels_name'];
      $price=$res['tassels_price'];
      $img=$res['tassels_image'];
    }
  if(isset($_POST['sbtn']))
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $tassles_status=1; 
      $str="update tassels_tbl set tassels_name='".$_POST['tname']."',tassels_image='".$image."',tassels_price='".$_POST['price']."'where tassels_id=".$_GET['up_id'];
      //echo $str;die;
	    $_SESSION['success']="Tassels update Successfully...";
    ...
    { 
     // echo "hii"; die;
      $tassles_status=1;
      $qry2="insert into tassels_tbl values(NULL,'".$_POST['tname']."','".$image."','".$_POST['price']."','".$tassels_status."') ";
    //  echo $qry2; die;
      //mysqli_query($cnn,$qry2);
      $tassles_success=mysqli_query($cnn,$qry2);
          if($tassels_success)
          {
            $_SESSION['success']="Tassels Added Successfully...";
          }
          else
           {
            $_SESSION['danger']="Oops!! Tassels Already Existed...";
          }
    }
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Tassels | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Tassels</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Tassels
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <label class="radio-inline"><input type="radio" name="optradio" value="Female">Female</label> 
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Tassels name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="tname" 
                placeholder="Tassels name" value="<?php echo $tname;?>"
              />
            </div>
      <div class="form-group">
              <label class="form-label" for="basic-default-name"> Tassels Image</label>
          ...
          <img src="profiles/<?php echo $img;?>" height="60px" width="60px"  
            ...
            <br>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Tassles price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Tassels price" value="<?php echo $price;?>"
              />
            </div>
     ...
     <script type="text/javascript">
      ...
      $(document).ready(function() {
          $("#custom_val").validate({
                ...
                messages : {
                      tname: {
                      required: "Tassels name should be at least 3 characters"
                    }
                }
