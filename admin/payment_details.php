...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title>Payment Details List | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
              			  <?php 
              				$qry="select * from payment_details_tbl,customer_tbl,order_tbl where payment_details_tbl.customer_id=customer_tbl.customer_id and payment_details_tbl.order_id=order_tbl.order_id";
                          ...
                          <tr>
                            ...
                            <td><?php echo $result['transcation_id'];?></td> 
