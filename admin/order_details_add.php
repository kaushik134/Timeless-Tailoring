                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
                      <?php 
                     $qry="select * from order_detail_tbl,order_tbl,delivery_tbl,customer_tbl where order_detail_tbl.order_id=order_tbl.order_id AND order_detail_tbl.delivery_id=delivery_tbl.delivery_id and order_detail_tbl.customer_id=customer_tbl.customer_id";
                     //echo $qry;
                        ...
                        ?>
                          <tr>
                            ...
                            <td><?php echo $result['name'];?>
                              <button type="button" style="" id="delivery" class="btn" data-id="<?php echo $result['delivery_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
                            ...
                            <td>
                              <?php if($result['status']==0) { ?>
                                                   ...
                                                   <a href="change_status.php?order_details_id=<?php echo $result['order_details_id'];?>&status=<?php echo $result['status'];?>"> 
                                                   <div class="fonticon-wrap">
