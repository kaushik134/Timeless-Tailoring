...
<!-- /auth-register.html by,  04:45:15 GMT -->
<head>
            ...
            <div class="row m-0">
                ...
                <div class="col-md-6 col-12 px-0">
                    <div class="card disable-rounded-right mb-0 p-2 h-100 d-flex justify-content-center">
                        ...
                        <div class="card-body">
                            <form action="https://www.pixinvent.com/demo/frest-clean-bootstrap-admin-dashboard-template/html/ltr/vertical-menu-boxicons-template/index.html">
                                <div class="form-row">
                            ...
                            <div class="text-center"><small class="mr-25">Already have an account?</small><a
                                    href="auth-login.html"><small>Sign in</small> </a></div>
                        </div>
                    </div>
                </div>
                <!-- image section right -->
