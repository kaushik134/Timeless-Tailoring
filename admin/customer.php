...
<head>
    ...
    <title>Customer | <?php echo $title;?></title>
                      ...
                      while($result=mysqli_fetch_array($test))
                      {
                        ...
                        <!--  <td><img style="border-radius:100px;" src="assets/addons/<?php echo $result['image']; ?>" height="100px" width="100px"></td> -->
                            ...
                            <td><?php echo $result['pincode'];?></td>
                              <td>
                              <?php if($result['customer_status']==0) { ?>
                                                   
                                                   <a href="change_status.php?customer_id=<?php echo $result['customer_id'];?>&customer_status=<?php echo $result['customer_status'];?>"> 
                                                ...
                                                <?php }?>
                                                    ...
                                                    <?php if($result['customer_status']==0) {echo "<span class='text-danger'>unordered</span>";} else { echo "<span class='text-success'>ordered</span>";}  ?>
                            </td>
