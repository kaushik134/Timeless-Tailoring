...
<head>
    ...
    <title>Unordered Customer | <?php echo $title;?></title>
                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">Unordered Customer</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
                      <?php 
                      $qry="select * from customer_tbl where customer_id not in (select customer_id from cart_tbl)";
