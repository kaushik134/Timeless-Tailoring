...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $qry1="select * from cups_tbl";
  $result=mysqli_query($cnn,$qry1);
  $cname=$price=$img='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from cups_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from cups_tbl where cups_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $cname=$res['cups_name'];
      $price=$res['cups_price'];
      $img=$res['cups_image'];
    }
  if(isset($_POST['sbtn']))
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $cups_status=1; 
      $str="update cups_tbl set cups_name='".$_POST['cname']."',cups_image='".$image."',cups_price='".$_POST['price']."'where cups_id=".$_GET['up_id'];
      //echo $str;die;
	    $_SESSION['success']="cups update Successfully...";
    ...
    { 
     // echo "hii"; die;
      $cups_status=1;
      $qry2="insert into cups_tbl values(NULL,'".$_POST['cname']."','".$image."','".$_POST['price']."','".$cups_status."') ";
    //  echo $qry2; die;
      //mysqli_query($cnn,$qry2);
      $cups_success=mysqli_query($cnn,$qry2);
          if($cups_success)
          {
            $_SESSION['success']="Cups Added Successfully...";
          }
          else
           {
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Cups | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Cups</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Cups
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <label class="radio-inline"><input type="radio" name="optradio" value="Female">Female</label> 
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Cups name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="cname" 
                placeholder="Cups name" value="<?php echo $cname;?>"
              />
            </div>
      <div class="form-group">
              <label class="form-label" for="basic-default-name"> Cups Image</label>
          ...
          <img src="profiles/<?php echo $img;?>" height="60px" width="60px"  
            ...
            <br>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Cups price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Cups price" value="<?php echo $price;?>"
              />
            </div>
     ...
     <script type="text/javascript">
      ...
      $(document).ready(function() {
          $("#custom_val").validate({
                ...
                messages : {
                      cname: {
                      required: "Cups name should be at least 3 characters"
                    }
                }
