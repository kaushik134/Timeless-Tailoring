...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $qry1="select * from frontneck_tbl";
  $result=mysqli_query($cnn,$qry1);
  $fname=$price=$img=$extra_instruction='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from frontneck_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from frontneck_tbl where frontneck_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $sname=$res['frontneck_name'];
      $price=$res['frontneck_price'];
      $img=$res['frontneck_image'];
  ...
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $frontneck_status=1; 
      $str="update frontneck_tbl set frontneck_name='".$_POST['fname']."',frontneck_image='".$image."',frontneck_price='".$_POST['price']."',extra_instruction='".$_POST['extra_instruction']."'where frontneck_id=".$_GET['up_id'];
    ...
    { 
     // echo "hii"; die;
      $frontneck_status=1;
      $qry2="insert into frontneck_tbl values(NULL,'".$_POST['fname']."','".$image."','".$_POST['price']."','".$_POST['extra_instruction']."','".$frontneck_status."') ";
    //  echo $qry2; die;
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Frontneck | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Frontneck</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Frontneck
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <?php }} ?>
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Frontneck name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="fname" 
                placeholder="frontneck name" value="<?php echo $fname;?>"
              />
            </div>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Frontneck Image</label>
            ...
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Frontneck price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Frontneck price" value="<?php echo $price;?>"
              />
            </div>
            <div class="form-group">
