...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $oname=$price=$img=$extra_instruction='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from opening_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from opening_tbl where opening_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $oname=$res['opening_name'];
      $price=$res['opening_price'];
      $img=$res['opening_image'];
  ...
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $opening_status=1; 
      $str="update opening_tbl set opening_name='".$_POST['oname']."',opening_image='".$image."',opening_price='".$_POST['price']."',extra_instruction='".$_POST['extra_instruction']."'where opening_id=".$_GET['up_id'];
    ...
    { 
     // echo "hii"; die;
      $opening_status=1;
      $qry2="insert into opening_tbl values(NULL,'".$_POST['oname']."','".$image."','".$_POST['price']."','".$_POST['extra_instruction']."','".$opening_status."') ";
    //  echo $qry2; die;
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Opening | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Opening</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Opening
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <?php }} ?>
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Opening name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="oname" 
                placeholder="Opening name" value="<?php echo $oname;?>"
              />
            </div>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Opening Image</label>
            ...
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Opening price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Opening price" value="<?php echo $price;?>"
              />
            </div>
            <div class="form-group">
     ...
     <script type="text/javascript">
      ...
      $(document).ready(function() {
          $("#custom_val").validate({
                ...
                messages : {
                      oname: {
                      required: "Opening name should be at least 3 characters"
                    }
                }
