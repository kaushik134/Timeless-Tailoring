...
<head>
    ...
    <title>Add Ons List | <?php echo $title;?></title>
                      ...
                      while($result=mysqli_fetch_array($test))
                      {
                        ?>
                          <tr>
                            ...
                            <!-- <td><?php echo $result['add_ons_status'];?></td> -->
                            <!-- <td>
                              <?php if($result['add_ons_status']==0) { ?>
                                                   
                                                   <a href="change_status.php?add_ons_id=<?php echo $result['add_ons_id'];?>&add_ons_status=<?php echo $result['add_ons_status'];?>"> 
                                                ...
                                                <?php }?>
                                                    ...
                                                    <?php if($result['add_ons_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?>
                            </td> -->
