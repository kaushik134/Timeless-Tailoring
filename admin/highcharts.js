...
(function (Z, M) {
  "object" === typeof module && module.exports
    ? ((M["default"] = M), (module.exports = Z.document ? M(Z) : M))
  ...
  M(a, "Core/Utilities.js", [a["Core/Globals.js"]], function (a) {
    function v(m, b, d, g) {
      ...
      var x = n(m),
        c = x
          ? D + " #" + m + ": www.highcharts.com/errors/" + m + "/"
          : m.toString();
      ...
      J(
        a,
        "displayError",
        { chart: d, code: m, message: c, params: g },
        function () {
          if (b) throw Error(c);
    ...
    function z(m, b) {
      var d = {};
      B(m, function (D, x) {
        if (H(m[x], !0) && !m.nodeType && b[x])
          (D = z(m[x], b[x])), Object.keys(D).length && (d[x] = D);
    ...
    function n(m) {
      return (
        "number" === typeof m && !isNaN(m) && Infinity > m && -Infinity < m
      );
    }
    function k(m) {
    ...
    function p(b, d, x) {
      ...
      if ("width" === d)
        return (
          ...
          (x = b.getBoundingClientRect && b.getBoundingClientRect().width),
          x < d && x >= d - 1 && (d = Math.floor(x)),
          Math.max(
            0,
            d -
              (m(b, "padding-left", !0) || 0) -
              (m(b, "padding-right", !0) || 0)
          )
        );
      if ("height" === d)
        return Math.max(
      ...
      if (r.createEvent && (b.dispatchEvent || (b.fireEvent && b !== a))) {
        ...
        for (var x = b, D = !1; x.hcEvents; )
          Object.hasOwnProperty.call(x, "hcEvents") &&
            x.hcEvents[d] &&
            (m.length && (D = !0), m.unshift.apply(m, x.hcEvents[d])),
      ...
      function (b, d) {
        a[d] = function (m) {
          ...
          v(
            ...
            !1,
            void 0,
            ((g = {}), (g["Highcharts." + d] = "use Array." + b), g)
          );
      ...
      (l.jQuery.fn.highcharts = function () {
        ...
        if (this[0])
          return b[0]
            ...
            : C[e(this[0], "data-highcharts-chart")];
      });
    b = {
      ...
      createElement: function (b, d, g, l, e) {
        b = r.createElement(b);
        d && c(b, d);
        e && f(b, { padding: "0", border: "none", margin: "0" });
        g && f(b, g);
        l && l.appendChild(b);
        return b;
      },
      ...
      normalizeTickInterval: function (b, d, g, l, c) {
        ...
        for (
          ...
          l < d.length &&
          !((m = d[l]),
          (c && m * g >= b) || (!c && r <= (d[l] + (d[l + 1] || d[l])) / 2));
          l++
        );
        return (m = w(m * g, -Math.round(Math.log(0.001) / Math.LN10)));
      },
      objectEach: B,
      offset: function (b) {
    ...
    function (a, u) {
      ...
      u = (function () {
        ...
        u.prototype.init = function (a) {
          ...
          if ("object" === typeof a && "undefined" !== typeof a.stops)
            ...
            if ("#" === a.charAt(0)) {
              ...
              7 === q
                ? (A = [(n & 16711680) >> 16, (n & 65280) >> 8, n & 255, 1])
                : 4 === q &&
                  (A = [
                    ((n & 3840) >> 4) | ((n & 3840) >> 8),
                    ((n & 240) >> 4) | (n & 240),
        ...
        u.prototype.tweenTo = function (a, A) {
          ...
          return (
            (a ? "rgba(" : "rgb(") +
            Math.round(n[0] + (q[0] - n[0]) * (1 - A)) +
            "," +
            Math.round(n[1] + (q[1] - n[1]) * (1 - A)) +
            "," +
            Math.round(n[2] + (q[2] - n[2]) * (1 - A)) +
            (a ? "," + (n[3] + (q[3] - n[3]) * (1 - A)) : "") +
            ")"
          );
        };
    ...
    function (a, u) {
      ...
      u = (function () {
        ...
        w.prototype.set = function (c, e, f) {
          ...
          return this.useUTC || (h && "FullYear" === c)
            ? e["setUTC" + c](f)
            : e["set" + c](f);
        };
        ...
        w.prototype.makeTime = function (c, e, h, w, C, r) {
          if (this.useUTC) {
            ...
            b !== g
              ? (l += g - b)
              : b - 36e5 !== this.getTimezoneOffset(l - 36e5) ||
                f ||
                (l -= 36e5);
          } else
            l = new this.Date(
        ...
        w.prototype.dateFormat = function (c, e, f) {
          ...
          q(h, function (b, d) {
            for (; -1 !== c.indexOf("%" + d); )
              c = c.replace(
                "%" + d,
                "function" === typeof b ? b.call(p, e) : b
              );
          });
        ...
        w.prototype.resolveDTLFormat = function (c) {
          return H(c, !0)
            ? c
            : ((c = e(c)), { main: c[0], from: c[1], to: c[2] });
        };
          ...
          if (F(h)) {
            ...
            g >= c.second &&
              p.set(
                "Seconds",
                b,
                g >= c.minute ? 0 : d * Math.floor(p.get("Seconds", b) / d)
              );
            g >= c.minute &&
              p.set(
                "Minutes",
                b,
                g >= c.hour ? 0 : d * Math.floor(p.get("Minutes", b) / d)
              );
            g >= c.hour &&
              p.set(
                "Hours",
                b,
                g >= c.day ? 0 : d * Math.floor(p.get("Hours", b) / d)
              );
            g >= c.day &&
              p.set(
                "Date",
                ...
                g >= c.month
                  ? 1
                  : Math.max(1, d * Math.floor(p.get("Date", b) / d))
              );
            if (g >= c.month) {
              p.set(
                "Month",
                b,
                g >= c.year ? 0 : d * Math.floor(p.get("Month", b) / d)
              );
            ...
            g === c.week &&
              ((D = p.get("Day", b)),
              p.set("Date", b, p.get("Date", b) - D + w + (D < w ? -7 : 0)));
            D = p.get("FullYear", b);
            w = p.get("Month", b);
            var x = p.get("Date", b),
              t = p.get("Hours", b);
            h = b.getTime();
            (!p.variableTimezone && p.useUTC) ||
              !F(f) ||
              (m =
                f - h > 4 * c.month ||
                p.getTimezoneOffset(h) !== p.getTimezoneOffset(f));
            h = b.getTime();
            for (b = 1; h < f; )
              r.push(h),
                (h =
                  g === c.year
                    ...
                    : !m || (g !== c.day && g !== c.week)
                    ? m && g === c.hour && 1 < d
                      ? p.makeTime(D, w, x, t + b * d)
                      : h + g * d
                    : p.makeTime(D, w, x + b * d * (g === c.day ? 1 : 7))),
                b++;
            r.push(h);
            g <= c.hour &&
              1e4 > r.length &&
              r.forEach(function (b) {
                0 === b % 18e5 &&
                  "000000000" === p.dateFormat("%H%M%S%L", b) &&
                  (l[b] = "day");
              });
          }
          r.info = G(e, { higherRanks: l, totalRange: g * d });
          return r;
        };
    ...
    function (a, u, z, F, y, G) {
      ...
      a = {
        ...
        setOptions: function (n) {
          ...
          if (n.time || n.global)
            z.time
              ? z.time.update(v(A.global, A.time, n.global, n.time))
              : (z.time = q);
          return A;
        },
      };
    ...
    function (a, u, z) {
      ...
      return (function () {
        ...
        a.prototype.run = function (q, n, k) {
          ...
          q !== n || this.elem["forceAnimate:" + this.prop]
            ? ((this.startTime = +new Date()),
              ...
              (h.elem = this.elem),
              (h.prop = this.prop),
              h() && 1 === a.timers.push(h) && f(w))
            : (delete c.curAnim[this.prop],
              c.complete &&
                0 === Object.keys(c.curAnim).length &&
        ...
        a.prototype.step = function (a) {
          ...
          if (e.attr && !e.element) a = !1;
            ...
            (this.pos = k.easing((n - this.startTime) / h)),
        ...
        a.prototype.initPath = function (a, n, k) {
          ...
          function c(c, e) {
            for (; c.length < J; )
              if (
                ((e = c[Math.floor(c.length / p) - 1].slice()),
      ...
      return {
        animate: function (c, e, f) {
          ...
          k(e, function (k, r) {
            ...
            B = void 0;
            "d" === r && H(e.d)
              ? ((t.paths = t.initPath(c, c.pathArray, e.d)),
                (t.toD = e.d),
                (h = 0),
                (B = 1))
              : c.attr
              ? (h = c.attr(r))
              : ((h = parseFloat(G(c, r)) || 0), "opacity" !== r && (p = "px"));
            B || (B = k);
            "string" === typeof B &&
              B.match("px") &&
              (B = B.replace(/px/g, ""));
        ...
        getDeferredAnimation: function (c, e, f) {
          ...
          return { defer: Math.max(0, p - a), duration: Math.min(p, a) };
        },
  ...
  M(
    ...
    function (a, u) {
      var v = a.SVG_NS,
        ...
        n = u.splat,
        k =
          (u = a.win.trustedTypes) &&
          H(u.createPolicy) &&
          u.createPolicy("highcharts", {
        ...
        h.filterUserAttributes = function (c) {
          q(c, function (e, p) {
            ...
            -1 !==
              ...
              (f =
                A(e) &&
                h.allowedReferences.some(function (c) {
                  return 0 === e.indexOf(c);
                }));
            f ||
              (G("Highcharts warning: Invalid attribute '" + p + "' in config"),
              delete c[p]);
          });
          return c;
        };
    ...
    function (a, u) {
      function v(a, k, e, c) {
        ...
        if (-1 === k) k = Math.min(f, 20);
          ...
          var B = k + +w[1];
          0 <= B
            ? ((w[0] = (+w[0]).toExponential(B).split("e")[0]), (k = B))
            : ((w[0] = w[0].split(".")[0] || 0),
              (a = 20 > k ? (w[0] * Math.pow(10, w[1])).toFixed(k) : 0),
              (w[1] = 0));
        }
        B = (
          Math.abs(w[1] ? w[0] : a) + Math.pow(10, -Math.max(k, f) - 1)
        ).toFixed(k);
        f = String(q(B));
        ...
        a =
          0 > +w[1] && !p
            ? "0"
            : a + f.substr(t).replace(/(\d{3})(?=\d)/g, "$1" + c);
        k && (a += e + B.slice(-k));
        w[1] && 0 !== +a && (a += "e" + w[1]);
        return a;
      }
        ...
        function u(a, q, n) {
            ...
            for (f = a.length; f--; )
              (e = a[f]),
                (c =
                  ...
                  2),
                (e.pos = v(c - e.size * e.align, 0, q - e.size));
            f = a.length;
            for (w = !1; f--; )
              0 < f &&
                ...
                (a[f - 1].align = 0.5),
                a[f - 1].pos + a[f - 1].size > q &&
                  (a[f - 1].pos = q - a[f - 1].size),
                a.splice(f, 1),
                (w = !0));
          }
          k.push.apply(k, p);
          ...
          a.some(function (c) {
            ...
            return (c.targets || []).some(function () {
              ...
              if (
                "undefined" !== typeof n &&
                Math.abs(k[f].pos - k[f].target) > n
              )
                return (
                  k.slice(0, f + 1).forEach(function (c) {
                    return delete c.pos;
                  }),
                  (k.reducedLen = (k.reducedLen || q) - 0.1 * q),
                  k.reducedLen > 0.1 * q && u(k, q, n),
                  !0
                );
              e += k[f].size;
              f++;
    ...
    function (a, u, z, F, y) {
      ...
      a = (function () {
        ...
        a.prototype.align = function (b, c, g) {
          ...
          if (b) {
            if (
              ((this.alignOptions = b), (this.alignByTranslate = c), !g || d(g))
            )
              (this.alignTo = l = g || "renderer"),
                J(e, this),
                e.push(this),
                (g = void 0);
          } else
        ...
        a.prototype.attr = function (b, d, c, g) {
          ...
          "string" === typeof b
            ? (l = (this[b + "Getter"] || this._defaultGetter).call(this, b, m))
            : (D(
                b,
                function (d, c) {
                  E = !1;
                  ...
                  this.symbolName &&
                    -1 !== e.indexOf(c) &&
                    (L || (this.symbolAttr(b), (L = !0)), (E = !0));
                  !this.rotation ||
                    ("x" !== c && "y" !== c) ||
                    (this.doTransform = !0);
                  E ||
                    ((a = this[c + "Setter"] || this._defaultSetter),
                    a.call(this, d, c, m),
                    !this.styledMode &&
                      this.shadows &&
            ...
            if (L) {
              ...
              if (E[B]) w = E[B].attr("id");
                ...
                x.forEach(function (b) {
                  ...
                  b = g
                    .createElement("stop")
                    .attr({ offset: b[0], "stop-color": p, "stop-opacity": f })
                    .add(K);
                  K.stops.push(b);
                });
              }
          ...
          if (l) {
            ...
            if (b)
              if (null === b.width || "auto" === b.width) delete this.textWidth;
                ...
                var r = (this.textWidth = I(b.width));
            this.styles = b;
        ...
        a.prototype.destroy = function () {
          ...
          for (
            ...
            m && m.div && 0 === m.div.childNodes.length;

          )
            (d = m.parentGroup),
              b.safeRemoveChild(m.div),
              delete m.div,
              (m = d);
        ...
        a.prototype.getBBox = function (d, c) {
          ...
          var p = g.styledMode
              ? m && a.prototype.getStyle.call(m, "font-size")
              : e && e.fontSize,
            f;
          if (t(l)) {
            var D = l.toString();
          ...
          if (!f) {
            ...
            g.isSVG &&
              ...
              c &&
                ((E = c * q),
                (f.width =
                  Math.abs(g * Math.sin(E)) + Math.abs(d * Math.cos(E))),
                (f.height =
                  Math.abs(g * Math.cos(E)) + Math.abs(d * Math.sin(E)))));
            if (D && ("" === l || 0 < f.height)) {
        ...
        a.prototype.init = function (b, d) {
          this.element =
            "span" === d ? p(d) : n.createElementNS(this.SVG_NS, d);
          this.renderer = b;
          r(this, "afterInit");
        };
        ...
        a.prototype.setTextPath = function (b, d) {
          ...
          if (b && d && d.enabled) {
            r && null === r.element.parentNode
              ? ((x = !0), (r = r.destroy()))
              : r && this.removeTextOutline.call(r.parentGroup);
            this.options &&
              this.options.padding &&
              (E.dx = -this.options.padding);
            r ||
              ((this.textPathWrapper = r =
            ...
            if (x)
              for (
                ...
                var f = b[x];
                (f.nodeType !== h.Node.TEXT_NODE && "tspan" !== f.nodeName) ||
                  p.appendChild(f);
              }
            l && r && r.add({ element: e });
            p.setAttributeNS(
        ...
        a.prototype.shadow = function (b, d, c) {
          ...
          if (!E) this.destroyShadows();
            ...
            for (a = 1; a <= E.width; a++) {
              ...
              c &&
                (w(h, "height", Math.max(w(h, "height") - x, 0)),
                (h.cutHeight = x));
              d
            ...
            : g &&
              a.push(
                "rotate(" +
                  g +
                  " " +
                  x(this.rotationOriginX, e.getAttribute("x"), 0) +
                  " " +
                  x(this.rotationOriginY, e.getAttribute("y") || 0) +
                  ")"
              );
        ...
        a.prototype.zIndexSetter = function (b, d) {
          ...
          t(b)
            ? (e.setAttribute("data-z-index", b),
              (b = +b),
              this[d] === b && (l = !1))
            : t(this[d]) && e.removeAttribute("data-z-index");
          this[d] = b;
          if (l) {
            ...
            for (E = d.length - 1; 0 <= E && !a; E--) {
              ...
              if (g !== e)
                ...
                else if (I(l) <= b || (r && (!t(b) || 0 <= b)))
                  m.insertBefore(e, d[E + 1] || null), (a = !0);
            }
    ...
    function (a, u) {
      ...
      return (function (n) {
        function k(e, c, a, f, w, p, B, t, J, C) {
          ...
          r.className = C;
          r.addClass(
            "button" === C ? "highcharts-no-tooltip" : "highcharts-label"
          );
          C && r.addClass("highcharts-" + C);
          r.text = e.text(void 0, 0, 0, t).attr({ zIndex: 1 });
          var l;
          "string" === typeof w &&
            ((l = /^url\((.*?)\)$/.test(w)) || r.renderer.symbols[w]) &&
            (r.symbolKey = w);
          r.bBox = k.emptyBBox;
          r.padding = 3;
          r.baselineOffset = 0;
        ...
        k.prototype.updateBoxSize = function () {
          ...
          this.baselineOffset =
            a +
            Math.min((this.text.firstLineMetrics || e).b, f.height || Infinity);
          this.heightSetting &&
          ...
          this.needsBox &&
            ...
            this.box.attr(y(c, this.deferredAttr)),
            (this.deferredAttr = {}));
        };
  ...
  M(a, "Core/Renderer/SVG/Symbols.js", [a["Core/Utilities.js"]], function (a) {
    function v(a, q, n, k, e) {
      ...
      if (e) {
        ...
        var w = (e.end || 0) - 0.001;
        k = e.innerR;
        var p = H(e.open, 0.001 > Math.abs((e.end || 0) - h - 2 * Math.PI)),
          B = Math.cos(h),
          t = Math.sin(h),
          J = Math.cos(w),
          C = Math.sin(w);
        h = H(e.longArc, 0.001 > w - h - Math.PI ? 0 : 1);
        c.push(
          ["M", a + f * B, q + n * t],
          ["A", f, n, 0, h, H(e.clockwise, 1), a + f * J, q + n * C]
        );
        y(k) &&
          c.push(
            p ? ["M", a + k * J, q + k * C] : ["L", a + k * J, q + k * C],
            [
              "A",
              k,
              k,
      ...
      return (function () {
        ...
        k.prototype.buildSVG = function () {
          ...
          if (t !== e.textCache) {
            ...
            this.ellipsis ||
            this.width ||
            (-1 !== f.indexOf(" ") && (!this.noWrap || B.test(f)))
              ? "" !== f &&
                (h && h.appendChild(c),
                (f = new a(f)),
                this.modifyTree(f.nodes),
                f.addToDOM(e.element),
                this.modifyDOM(),
                this.ellipsis &&
                ...
                h && h.removeChild(c))
              : c.appendChild(v.createTextNode(this.unescapeEntities(f)));
            A(this.textOutline) &&
              e.applyTextOutline &&
          ...
          [].forEach.call(
            ...
            function (e, p) {
              e.nextSibling &&
                ...
                H(e, { dy: a.getLineHeight(e.nextSibling), x: h }));
            }
          );
          var k = this.width || 0;
          if (k) {
            var p = function (e, p) {
                var f = e.textContent || "",
                  ...
                  l =
                    !a.noWrap &&
                    (1 < r.length || 1 < c.element.childNodes.length),
                  b = a.getLineHeight(p),
                  g = 0,
                  d = c.actualWidth;
                if (a.ellipsis)
                  f &&
                    a.truncate(
                      ...
                      void 0,
                      0,
                      Math.max(0, k - parseInt(a.fontSize || 12, 10)),
                      function (b, d) {
                  ...
                  f = [];
                  for (l = []; p.firstChild && p.firstChild !== e; )
                    l.push(p.firstChild), p.removeChild(p.firstChild);
                  for (; r.length; )
                    r.length &&
                      !a.noWrap &&
                      0 < g &&
                      (f.push(e.textContent || ""),
            ...
            e = function (h, k) {
              ...
              if ("b" === t || "strong" === t)
                w
                  ...
                  : (p.style = "font-weight:bold;" + (p.style || ""));
              else if ("i" === t || "em" === t)
                w
                  ? (p["class"] = "highcharts-emphasized")
                  : (p.style = "font-style:italic;" + (p.style || ""));
              A(p.style) &&
                (p.style = p.style.replace(/(;| |^)color([ :])/, "$1fill$2"));
              "br" === t
            ...
            d = function (b, d) {
              ...
              if (g && "undefined" === typeof n[d])
                if (g.getSubStringLength)
                  ...
                  t.getSpanWidth &&
                    ((a.textContent = p(c || h, b)),
                    (n[d] = f + t.getSpanWidth(e, a)));
              return n[d];
            };
          e.rotation = 0;
          ...
          if (f + m > k) {
            for (; r <= l; )
              (b = Math.ceil((r + l) / 2)),
                h && (g = p(h, b)),
                (m = d(b, g && g.length - 1)),
                r === l ? (r = l + 1) : m > k ? (l = b - 1) : (r = b);
            0 === l
              ? (a.textContent = "")
              : (c && l === c.length - 1) ||
                (a.textContent = g || p(c || h, b));
          }
          h && h.splice(0, b);
          e.actualWidth = m;
          e.rotation = w;
      ...
      z = (function () {
        ...
        L.prototype.init = function (b, d, a, g, m, E, L) {
          ...
          this.createElement("desc")
            .add()
            .element.appendChild(
              e.createTextNode("Created with Highcharts 9.3.3")
            );
          ...
          c &&
            ...
            d(),
            (this.unSubPixelFix = J(t, "resize", d)));
        };
        ...
        L.prototype.getReferenceURL = function () {
          if ((c || f) && e.getElementsByTagName("base").length) {
            if (!b(Y)) {
              ...
              l(d, { position: "fixed", top: 0, left: 0, zIndex: 9e5 });
        ...
        L.prototype.crispLine = function (d, a, c) {
          ...
          b(g[1]) &&
            g[1] === m[1] &&
            (g[1] = m[1] = Math[c](g[1]) - (a % 2) / 2);
          b(g[2]) &&
            g[2] === m[2] &&
            (g[2] = m[2] = Math[c](g[2]) + (a % 2) / 2);
          return d;
        };
        ...
        L.prototype.circle = function (b, d, a) {
          b = x(b) ? b : "undefined" === typeof b ? {} : { x: b, y: d, r: a };
        ...
        L.prototype.arc = function (b, d, a, c, g, m) {
          x(b)
            ? ((c = b), (d = c.y), (a = c.r), (b = c.x))
            : (c = { innerR: c, start: g, end: m });
        ...
        L.prototype.rect = function (b, d, a, c, g, m) {
          ...
          b = x(b)
            ...
            : "undefined" === typeof b
            ? {}
            : { x: b, y: d, width: Math.max(a, 0), height: Math.max(c, 0) };
          this.styledMode ||
            ("undefined" !== typeof m &&
              ((b["stroke-width"] = m), (b = e.crisp(b))),
            (b.fill = "none"));
          g && (b.r = g);
        ...
        L.prototype.symbol = function (a, c, g, m, L, E) {
          ...
          if (D) {
            ...
            d(K, { symbolName: f || void 0, x: c, y: g, width: m, height: L });
            E && d(K, E);
          } else if (x) {
            var w = a.match(h)[1];
            ...
            ["width", "height"].forEach(function (d) {
              t[d + "Setter"] = function (d, a) {
                ...
                b(c) &&
                  ...
                  this.element && this.element.setAttribute(a, c),
                  this.alignByTranslate ||
                    ((d = ((this[a] || 0) - c) / 2),
                    this.attr(
                      "width" === a ? { translateX: d } : { translateY: d }
                    )));
              };
            });
            b(c) && t.attr({ x: c, y: g });
              ...
              : (t.attr({ width: 0, height: 0 }),
                r("img", {
                  onload: function () {
                    ...
                    0 === this.width &&
                      (l(this, { position: "absolute", top: "-999em" }),
                      e.body.appendChild(this));
                    B[w] = { width: this.width, height: this.height };
        ...
        L.prototype.clipRect = function (b, d, a, c) {
          var g = U() + "-",
            m = this.createElement("clipPath").attr({ id: g }).add(this.defs);
        ...
        L.prototype.text = function (d, a, c, g) {
          ...
          if (g && (this.allowHTML || !this.forExport))
            return this.html(d, a, c);
          m.x = Math.round(a || 0);
          c && (m.y = Math.round(c));
          b(d) && (m.text = d);
          d = this.createElement("text").attr(m);
          if (!g || (this.forExport && !this.allowHTML))
            d.xSetter = function (b, d, a) {
              for (
                var c = a.getElementsByTagName("tspan"),
                  g = a.getAttribute(d),
                  m = 0,
                  e;
                m < c.length;
        ...
        L.prototype.fontMetrics = function (b, d) {
          b =
            (!this.styledMode && /px/.test(b)) || !t.getComputedStyle
              ? b ||
        ...
        L.prototype.pathToSegments = function (b) {
          for (
            ...
            I(a[0]) &&
              ...
              b.splice(g, 0, a[0].replace("M", "L").replace("m", "l")),
              "string" === typeof b[g] &&
                (a.length && d.push(a.slice(0)), (a.length = 0)),
              a.push(b[g]);
          d.push(a.slice(0));
          return d;
        };
    ...
    function (a, u, z) {
      ...
      return (function (a) {
        ...
        h.prototype.htmlUpdateTransform = function () {
          if (this.added) {
            var a = this.renderer,
              ...
              l = { left: 0, center: 0.5, right: 1 }[r],
              b = this.styles;
            b = b && b.whiteSpace;
            q(e, { marginLeft: h, marginTop: f });
            !a.styledMode &&
              this.shadows &&
              this.shadows.forEach(function (b) {
                q(b, { marginLeft: h + 1, marginTop: f + 1 });
              });
            this.inverted &&
            ...
            if ("SPAN" === e.tagName) {
              ...
              if (d !== this.oldTextWidth) {
                if (this.textPxLength) var x = this.textPxLength;
                  ...
                  q(e, { width: "", whiteSpace: b || "nowrap" }),
                    (x = e.offsetWidth);
                (d > this.oldTextWidth || x > d) &&
              ...
              m !== this.cTT &&
                ((D = a.fontMetrics(e.style.fontSize, e).b),
                !n(g) ||
                  (g === (this.oldRotation || 0) && r === this.oldAlign) ||
                  this.setSpanRotation(g, l, D),
                this.getSpanCorrection(
                  (!n(g) && this.textPxLength) || e.offsetWidth,
                  D,
                  l,
                  g,
                  r
        ...
        h.prototype.setSpanRotation = function (a, c, e) {
          var h = {},
            p =
              G && !/Edge/.test(A.navigator.userAgent)
                ? "-ms-transform"
                : H
                ? "-webkit-transform"
                : y
                ...
                : void 0;
          p &&
            ((h[p] = h.transform = "rotate(" + a + "deg)"),
            (h[p + (y ? "Origin" : "-origin")] = h.transformOrigin =
              100 * c + "% " + e + "px"),
            q(this.element, h));
        };
        h.composedClasses = [];
    ...
    function (a, u, z, F) {
      ...
      return (function (n) {
        ...
        k.compose = function (a) {
          -1 === k.composedClasses.indexOf(a) &&
            (k.composedClasses.push(a), (a.prototype.html = k.prototype.html));
          return a;
        };
        k.prototype.html = function (e, c, h) {
          ...
          f.attr({ text: e, x: Math.round(c), y: Math.round(h) }).css({
            position: "absolute",
          });
          p.styledMode ||
            f.css({
                  ...
                  e.reverse().forEach(function (b) {
                    ...
                    A(b, {
                      ...
                      on: function () {
                        e[0].div &&
                          f.on.apply(
                            { element: e[0].div, onEvents: b.onEvents },
                            arguments
                          );
                        return b;
                      },
    ...
    (function (a) {
      a.registerEventOptions = function (a, q) {
        ...
        F(q.events, function (n, k) {
          a.eventOptions[k] !== n &&
            (a.eventOptions[k] &&
              (y(a, k, a.eventOptions[k]), delete a.eventOptions[k]),
            z(n) && ((a.eventOptions[k] = n), v(a, k, n)));
        });
      };
    })(G || (G = {}));
    return G;
    ...
    function (a, u, z) {
      ...
      u = (function () {
        ...
        f.prototype.addLabel = function () {
          ...
          if (e.dateTime)
            if (g) {
              var P = t.time.resolveDTLFormat(
                f.dateTimeLabelFormats[
                  (!f.grid && g.higherRanks[l]) || g.unitName
                ]
              );
              var v = P.main;
            } else
              k(J) &&
                (v = e.dateTime.getXDateFormat(
                  J,
                  f.dateTimeLabelFormats || {}
                ));
          c.isFirst = d;
          ...
          var u = function (d) {
            return b.formatter
              ? b.formatter.call(d, d)
              : b.format
              ? ((d.text = e.defaultLabelFormatter.call(d)),
                a.format(b.format, d, t))
              : e.defaultLabelFormatter.call(d, d);
          };
          f = u.call(O, O);
          var A = P && P.list;
          c.shortenLabel = A
            ? function () {
                for (I = 0; I < A.length; I++)
                  if (
                    (q(O, { dateTimeLabelFormat: A[I] }),
                    x.attr({ text: u.call(O, O) }),
                    x.getBBox().width < e.getSlotWidth(c) - 2 * b.padding)
                  )
                    return;
                x.attr({ text: "" });
              }
          ...
          H(x) || c.movedLabel
            ...
            : ((c.label = x = c.createLabel({ x: 0, y: 0 }, f, b)),
              (c.rotation = 0));
        };
        f.prototype.createLabel = function (a, c, h) {
          ...
          if (
            (a =
              H(c) && h.enabled
                ? p.renderer.text(c, a.x, a.y, h.useHTML).add(f.labelGroup)
                : null)
          )
            p.styledMode || a.css(e(h.style)),
        ...
        f.prototype.getPosition = function (a, c, e, h) {
          ...
          a = {
            x: a
              ? G(f.translate(c + e, null, null, h) + f.transB)
              : f.left +
                f.offset +
                (f.opposite
                  ? ((h && p.oldChartWidth) || p.chartWidth) - f.right - f.left
                  : 0),
            y: a
              ? r - f.bottom + f.offset - (f.opposite ? f.height : 0)
              : G(r - f.translate(c + e, null, null, h) - f.transB),
          };
          a.y = y(a.y, -1e5, 1e5);
        ...
        f.prototype.getLabelPosition = function (a, c, e, h, f, k, r, l) {
          var b = this.axis,
            g = b.transA,
            d =
              b.isLinked && b.linkedParent
                ? b.linkedParent.reversed
                : b.reversed,
            m = b.staggerLines,
            D = b.tickRotCorr || { x: 0, y: 0 },
            x =
              h || b.reserveSpaceDefault
                ? 0
        ...
        f.prototype.handleOverflow = function (a) {
          ...
          n = h(
            c.labelRight,
            Math.max(c.isRadial ? 0 : c.pos + c.len, k - n[1])
          );
          var l = this.label,
            b = this.rotation,
          ...
          if (b || "justify" !== e.overflow)
            0 > b && f - g * d < r
              ? (w = Math.round(f / Math.cos(b * v) - r))
              : 0 < b &&
                f + g * d > n &&
                (w = Math.round((k - f) / Math.cos(b * v)));
          else if (
            ((k = f + (1 - g) * d),
            f - g * d < r
              ? (x = a.x + x * (1 - g) - r)
            ...
            x < m &&
              "center" === c.labelAlign &&
              (a.x += I * (m - x - g * (m - Math.min(d, x)))),
            d > x || (c.autoRotation && (l.styles || {}).width))
          )
            w = x;
          w &&
            (this.shortenLabel
              ? this.shortenLabel()
              : ((D.width = Math.floor(w) + "px"),
                (e.style || {}).textOverflow || (D.textOverflow = "ellipsis"),
                l.css(D)));
        };
        f.prototype.moveLabel = function (a, e) {
          var h = this,
            ...
            r = !1;
          f && f.textStr === a
            ? ((h.movedLabel = f), (r = !0), delete h.label)
            : c(k.ticks, function (b) {
                r ||
                  b.isNew ||
                  b === h ||
                  !b.label ||
                  b.label.textStr !== a ||
                  ((h.movedLabel = b.label),
                  (r = !0),
                  (b.labelPos = h.movedLabel.xy),
                  delete b.label);
              });
          if (!r && (h.labelPos || f)) {
            ...
            h.movedLabel = h.createLabel({ x: f, y: k }, a, e);
        ...
        f.prototype.renderGridLine = function (a, c, e) {
          ...
          "minor" === this.type &&
            ((m = k.minorGridLineWidth),
            (D = k.minorGridLineColor),
            (x = k.minorGridLineDashStyle));
          d ||
            (f.chart.styledMode ||
              ((p.stroke = D), (p["stroke-width"] = m || 0), (p.dashstyle = x)),
            l || (p.zIndex = 1),
            a && (c = 0),
            (this.gridLine = d =
              g
                .path()
                .attr(p)
                .addClass("highcharts-" + (l ? l + "-" : "") + "grid-line")
                .add(f.gridGroup)));
          if (
            d &&
            (e = f.getPlotLinePath({
            ...
            d[a || this.isNew ? "attr" : "animate"]({ d: e, opacity: c });
        };
        f.prototype.renderMark = function (a, c, e) {
          ...
          a = a.y;
          var g = h(
            k["minor" !== r ? "tickWidth" : "minorTickWidth"],
            !r && f.isXAxis ? 1 : 0
          );
            ...
            d ||
              ((this.mark = d =
                p
                  ...
                  .add(f.axisGroup)),
              f.chart.styledMode || d.attr({ stroke: k, "stroke-width": g })),
            d[m ? "attr" : "animate"]({
        ...
        f.prototype.renderLabel = function (a, c, e, f) {
          ...
          l &&
            k(d) &&
            ((l.xy = a = this.getLabelPosition(d, a, l, n, b, p, f, g)),
            (this.isFirst && !this.isLast && !r.showFirstLabel) ||
            (this.isLast && !this.isFirst && !r.showLastLabel)
              ? (m = !1)
              : !n ||
                b.step ||
                b.rotation ||
            ...
            m && k(a.y)
              ? ((a.opacity = e),
                l[this.isNewLabel ? "attr" : "animate"](a),
                (this.isNewLabel = !1))
    ...
    function (a, u, z, F, y, G, H, A) {
      ...
      a = (function () {
                ...
                if (b.isXAxis) {
                  if (((e = c.xData), e.length)) {
                    ...
                    g(l) ||
                      ...
                      (f = a.max));
                    e.length &&
                      ((b.dataMin = Math.min(I(b.dataMin, l), l)),
                      (b.dataMax = Math.max(I(b.dataMax, f), f)));
                  }
                } else if (
                  ((c = c.applyExtremes()),
                  g(c.dataMin) &&
        ...
        a.prototype.translate = function (b, d, a, c, e, m) {
          ...
          d
            ? ((b = (b * h + k - r) / c + f), e && (b = l.lin2val(b)))
            : (e && (b = l.val2lin(b)),
              (b = g(f)
                ? h * (b - f) * c + k + h * r + (g(m) ? c * m : 0)
                : void 0));
          return b;
        };
        a.prototype.toPixels = function (b, d) {
          return (
            this.translate(b, !1, !this.horiz, null, !0) + (d ? 0 : this.pos)
          );
        };
        ...
        a.prototype.getPlotLinePath = function (b) {
          ...
          r(this, "getPlotLinePath", b, function (b) {
            ...
            g(p)
              ? a.horiz
                ? ((C = m), (q = x - a.bottom), (t = w = d(t, e, e + a.width)))
                : ((t = e), (w = D - a.right), (C = q = d(C, m, m + a.height)))
              : ((B = !0), (n = !1));
            b.path =
              B && !n
                ? null
        ...
        a.prototype.getMinorTickPositions = function () {
          ...
          if (g && g / a < this.len / 3) {
            ...
            if (l)
              this.paddedTicks.forEach(function (b, d, c) {
                d &&
                  m.push.apply(m, l.getLogTickPositions(a, c[d - 1], c[d], !0));
              });
        ...
        a.prototype.adjustForMinRange = function () {
          ...
          this.isXAxis &&
            ...
            !d &&
            (p(b.min) || p(b.max) || p(b.floor) || p(b.ceiling)
              ? (this.minRange = null)
        ...
        a.prototype.nameToX = function (d) {
          ...
          "undefined" !== typeof g &&
            ((this.names[g] = d.name), (this.names.keys[d.name] = g));
          return g;
        };
        ...
        a.prototype.setAxisTranslation = function () {
          ...
          if (g || e || m) {
            var k = b.getClosest();
            c
              ? ((l = c.minPointOffset), (f = c.pointRangePadding))
              : b.series.forEach(function (a) {
                  var c = e
                      ? 1
                      : g
                      ? I(a.options.pointRange, k, 0)
                      : b.axisPointRange || 0,
                    h = a.options.pointPlacement;
                  m = Math.max(m, c);
                  if (!b.single || e)
                    (a = a.is("xrange") ? !g : g),
                      (l = Math.max(l, a && d(h) ? 0 : c / 2)),
                      (f = Math.max(f, a && "on" === h ? 0 : c));
                });
        ...
        a.prototype.setTickInterval = function (b) {
          var d = this.chart,
            ...
            L = c.minPadding,
            n =
              g(c.tickInterval) && 0 <= c.tickInterval
                ? c.tickInterval
                : void 0,
          ...
          a &&
            (this.positiveValuesOnly &&
              !b &&
              0 >= Math.min(this.min, I(this.dataMin, this.min)) &&
              J(10, 1, d),
            (this.min = w(a.log2lin(this.min), 16)),
            (this.max = w(a.log2lin(this.max), 16)));
          this.range &&
            p(this.max) &&
            ((this.userMin =
              this.min =
          ...
          !(
            ...
            !p(q) && x && (this.max += d * x));
          g(this.userMin) ||
            (g(c.softMin) && c.softMin < this.min && (this.min = C = c.softMin),
            g(c.floor) && (this.min = Math.max(this.min, c.floor)));
          g(this.userMax) ||
            (g(c.softMax) && c.softMax > this.max && (this.max = q = c.softMax),
            g(c.ceiling) && (this.max = Math.min(this.max, c.ceiling)));
          k &&
            p(this.dataMin) &&
            ((t = t || 0),
            !p(C) && this.min < t && this.dataMin >= t
        ...
        a.prototype.setTickPositions = function () {
          ...
          !a &&
            ...
            !(
              ...
              : ((a = [this.min, this.max]), J(19, !1, this.chart)),
            a.length > this.len &&
        ...
        a.prototype.adjustTickAmount = function () {
          ...
          if (this.hasData() && g(this.min) && g(this.max)) {
            if (m < c) {
              for (; a.length < c; )
                a.length % 2 || this.min === l
                  ? a.push(w(a[a.length - 1] + d))
                  : a.unshift(w(a[0] - d));
              this.transA *= (m - 1) / (c - 1);
          ...
          r(this, "zoom", b, function (b) {
            ...
            if (d !== a.min || g !== a.max)
              a.allowZoomOutside ||
                ...
                p(e) && (g < m && (g = m), g > l && (g = l))),
                (a.displayBtn =
                  "undefined" !== typeof d || "undefined" !== typeof g),
                a.setExtremes(d, g, !1, void 0, { trigger: "zoom" });
            b.zoomed = !0;
          });
          return b.zoomed;
        };
        a.prototype.setAxisSize = function () {
          var b = this.chart,
            ...
            e = (this.width = Math.round(
              P(I(d.width, b.plotWidth - a[3] + a[1]), b.plotWidth)
            )),
            g = (this.height = Math.round(
              P(I(d.height, b.plotHeight - a[0] + a[2]), b.plotHeight)
            )),
            m = (this.top = Math.round(
              P(I(d.top, b.plotTop + a[0]), b.plotHeight, b.plotTop)
            ));
          d = this.left = Math.round(
            P(I(d.left, b.plotLeft + a[3]), b.plotWidth, b.plotLeft)
          );
              ...
              for (h = c.length; !l && h--; ) {
                ...
                if ((I = e[I].label))
                  I.styles && "ellipsis" === I.styles.textOverflow
                    ...
                    : I.textPxLength > f && I.css({ width: f + "px" }),
                    I.getBBox().height > this.len / c.length - (k.h - k.f) &&
                      (I.specificTextOverflow = "ellipsis");
              }
            }
          }
          r.rotation &&
            ((p = D > 0.5 * b.chartHeight ? 0.33 * b.chartHeight : D),
            x || (n = "ellipsis"));
          if (
            (this.labelAlign =
          ...
          c.forEach(function (b) {
            ...
            d &&
              ...
              b.shortenLabel
                ...
                ? ((c.width = p + "px"),
                  x || (c.textOverflow = d.specificTextOverflow || n),
                  d.css(c))
                : d.styles &&
                  d.styles.width &&
                  !c.width &&
        ...
        a.prototype.addTitle = function (b) {
          ...
          this.axisTitle ||
            ...
            (this.axisTitle = d
              ...
              .attr({ zIndex: 7, rotation: e.rotation, align: l })
              .addClass("highcharts-axis-title")),
            g || this.axisTitle.css(m(e.style)),
        ...
        a.prototype.getOffset = function () {
          ...
          if (
            ...
            t.text &&
            !1 !== t.enabled &&
            (d.addTitle(P), P && !1 !== t.reserveSpace)
          ) {
          ...
          d.getMaxLabelDiwomensions &&
            (d.maxLabelDiwomensions = d.getMaxLabelDiwomensions(m, l));
          "colorAxis" !== f &&
            ((c = this.tickSize("tick")),
            (q[g] = Math.max(
              q[g],
              (d.axisTitleMargin || 0) + J + w * d.offset,
              n,
              l && l.length && c ? c[0] + w * d.offset : 0
            )),
            (e =
              !d.axisLine || e.offset
                ? 0
        ...
        a.prototype.getTitlePosition = function () {
          ...
          d =
            (b ? a + this.height : d) +
            (b ? 1 : -1) * (m ? -1 : 1) * this.axisTitleMargin +
            [-k, k, x.f, -k][this.side];
          b = {
        ...
        a.prototype.render = function () {
          ...
          if (b.hasData() || e) {
            ...
            m.length &&
              ...
              n &&
                (0 === b.min || b.single) &&
                (f[-1] || (f[-1] = new H(b, -1, null, !0)), f[-1].render(-1)));
            p &&
              m.forEach(function (c, e) {
                ...
                0 === e % 2 &&
                  c < b.max &&
                  B <= b.max + (d.polar ? -n : n) &&
                  (k[c] || (k[c] = new G.PlotLineOrBand(b)),
                  (w = c + n),
                  (k[c].options = {
        ...
        a.prototype.drawCrosshair = function (b, d) {
          var a = this.crosshair,
            ...
            g,
            m = this.cross;
          r(this, "drawCrosshair", { e: b, point: d });
                ...
                (m
                  .attr({
                    stroke:
                      a.color ||
                      (c
                        ? z.parse("#ccd6eb").setOpacity(0.25).get()
                        : "#cccccc"),
                    "stroke-width": I(a.width, 1),
                  })
                  .css({ "pointer-events": "none" }),
                a.dashStyle && m.attr({ dashstyle: a.dashStyle })));
            m.show().attr({ d: l });
            c && !a.width && m.attr({ "stroke-width": this.transA });
            this.cross.e = b;
          } else this.hideCrosshair();
          r(this, "afterDrawCrosshair", { e: b, point: d });
        };
      ...
      var k = (function () {
        ...
        a.prototype.normalizeTimeTickInterval = function (a, e) {
          ...
          for (
            ...
            (h = y[e[0]]),
            (k = e[1]),
            c[n + 1] && a <= (h * k[k.length - 1] + y[c[n + 1][0]]) / 2);
            n++
          );
          h === y.year && a < 5 * h && (k = [1, 2, 5]);
          a = F(a / h, k, "year" === e[0] ? Math.max(z(a / h), 1) : 1);
          return { unitRange: h, count: a, unitName: e[0] };
        };
        a.prototype.getXDateFormat = function (a, e) {
          var c = this.axis;
          return c.closestPointRange
            ? c.chart.time.getDateFormat(
                c.closestPointRange,
                a,
                c.options.startOfWeek,
                e
              ) || e.year
            : e.day;
        };
    ...
    (function (a) {
      ...
      var k = (function () {
        ...
        a.prototype.getLogTickPositions = function (a, e, f, k) {
          ...
          if (0.5 <= a)
            (a = Math.round(a)), (q = c.getLinearTickPositions(a, e, f));
          else if (0.08 <= a) {
            var C = Math.floor(e),
              r,
              l = (n = void 0);
            ...
            (e = this.lin2log(e)),
              (f = this.lin2log(f)),
              (a = k ? c.getMinorTickInterval() : n.tickInterval),
              (a = y(
                "auto" === a ? null : a,
                this.minorAutoInterval,
                ((n.tickPixelInterval / (k ? 5 : 1)) * (f - e)) /
                  ((k ? h / c.tickPositions.length : h) || 1)
              )),
              (a = F(a, void 0, z(a))),
              (q = c.getLinearTickPositions(a, e, f).map(this.log2lin)),
              k || (this.minorAutoInterval = a / 5);
          k || (c.tickInterval = a);
          return q;
        };
      ...
      u = (function () {
        ...
        e.prototype.render = function () {
          ...
          e.chart.styledMode ||
            (x
              ? ((S.stroke = B || "#999999"),
                (S["stroke-width"] = k(p.width, 1)),
                p.dashStyle && (S.dashstyle = p.dashStyle))
              : I &&
                ((S.fill = B || "#e6ebf5"),
                p.borderWidth &&
                  ((S.stroke = p.borderColor),
                  (S["stroke-width"] = p.borderWidth))));
          C.zIndex = t;
          O += "-" + t;
          (w = e.plotLinesAndBandsGroups[O]) ||
            (e.plotLinesAndBandsGroups[O] = w =
              r
                .g("plot-" + O)
                .attr(C)
                .add());
          ...
          (P || !D.d) && x && x.length
            ...
            : D &&
              (x
                ? (D.show(!0), D.animate({ d: x }))
                : D.d && (D.hide(), b && (a.label = b = b.destroy())));
          l &&
          (y(l.text) || y(l.formatter)) &&
          x &&
          x.length &&
          0 < e.width &&
          0 < e.height &&
          ...
          n ||
            ((this.label = n =
              h
                ...
                .add()),
            c.chart.styledMode ||
              n.css(q({ textOverflow: "ellipsis" }, a.style)));
          k = e.xBounds || [e[0][1], e[1][1], f ? e[2][1] : e[0][1]];
          e = e.yBounds || [e[0][2], e[1][2], f ? e[2][2] : e[0][2]];
          f = F(k);
          h = F(e);
          n.align(a, !1, { x: f, y: h, width: v(k) - f, height: v(e) - h });
          (n.alignValue && "left" !== n.alignValue) ||
            n.css({
              width:
                (90 === n.rotation
                  ? c.height - (n.alignAttr.y - c.top)
                  : c.width - (n.alignAttr.x - c.left)) + "px",
            });
          n.show(!0);
        };
      ...
      a = (function () {
        ...
        a.prototype.getAnchor = function (b, a) {
          ...
          this.followPointer && a
            ? ("undefined" === typeof a.chartX && (a = c.normalize(a)),
              (c = [a.chartX - l, a.chartY - g]))
            : b[0].tooltipPos
            ? (c = b[0].tooltipPos)
            : (b.forEach(function (b) {
                ...
                r &&
                  f &&
                  (e
                    ? ((h += g + d.plotHeight - r.len - r.pos),
                      (k += l + d.plotWidth - f.len - f.pos))
                    : ((h += r.pos - l), (k += f.pos - g)));
              }),
              (h /= b.length),
              (k /= b.length),
              (c = [e ? d.plotWidth - k : h, e ? d.plotHeight - h : k]),
              this.shared &&
                1 < b.length &&
                a &&
                (e ? (c[0] = a.chartX - l) : (c[1] = a.chartY - g)));
        ...
        a.prototype.getLabel = function () {
          var b = this,
            ...
            f =
              ...
              (!this.followPointer && d.stickOnContact ? "auto" : "none"),
            r = function () {
              b.inContact = !0;
            },
            h = function (a) {
              ...
              b.inContact =
                b.shouldStickOnContact() &&
                b.chart.pointer.inClass(a.relatedTarget, "highcharts-tooltip");
        ...
        a.prototype.init = function (b, a) {
          ...
          this.outside = J(
            a.outside,
            !(!b.scrollablePixelsX && !b.scrollablePixelsY)
          );
        };
        ...
        a.prototype.move = function (b, a, d, c) {
          var e = this,
            ...
            m =
              ...
              !e.isHidden &&
              (1 < Math.abs(b - g.x) || 1 < Math.abs(a - g.y)),
            ...
            if (!1 === r) this.hide();
              ...
              if (this.split && this.allowShared) this.renderSplit(r, e);
                ...
                a &&
                  ...
                  ((q = a.chartX - d.plotLeft), (B = a.chartY - d.plotTop));
                if (
                  d.polar ||
                  !1 === h.options.clip ||
                  e.some(function (b) {
                  ...
                  (a = this.getLabel()),
                    ...
                    a
                      ...
                      .addClass(
                        "highcharts-color-" + J(g.colorIndex, h.colorIndex)
                      ),
                    k ||
                      a.attr({
                        stroke:
                          c.borderColor || g.color || h.color || "#666666",
                      }),
                    this.updatePosition({
                      plotX: n,
                      plotY: t,
        ...
        a.prototype.renderSplit = function (b, a) {
          function d(b, a, d, e, g) {
            ...
            d
              ? ((a = X ? 0 : G),
                (b = n(b - e / 2, N.left, N.right - e - (c.outside ? R : 0))))
              : ((a -= z),
                (b = g ? b - e - y : b + y),
                (b = n(b, g ? b : N.left, N.right)));
            return { x: b, y: a };
          }
          var c = this,
            e = c.chart,
          ...
          var u = g.styledMode,
            ...
            N =
              c.outside && "number" !== typeof q
                ? H.documentElement.getBoundingClientRect()
                : { left: v, right: v + l, top: w, bottom: w + f },
            V = c.getLabel(),
          ...
          b = b.slice(0, a.length + 1).reduce(function (b, e, g) {
            if (!1 !== e && "" !== e) {
              ...
              var x = g.series;
              var D =
                "highcharts-color-" + J(g.colorIndex, x.colorIndex, "none");
              f ||
                ((f = { padding: E.padding, r: E.borderRadius }),
                u ||
              ...
              if (g.isHeader) {
                ...
                f.shouldShowTooltip(0, C.pos - p + D, { ignoreX: !0 }) &&
                  (t = C.pos + D);
              }
              x = n(x, N.left - y, N.right + y);
              "number" === typeof t
                ? ((h = h.height + 1),
                  (D = T ? T.call(c, e, h, g) : d(x, t, m, e)),
                  b.push({
                    align: T ? 0 : void 0,
                    anchorX: x,
                    anchorY: t,
          ...
          b.forEach(function (b) {
            ...
            b = b.isHeader;
            b ||
              (c.outside && R + a < F && (F = R + a),
              !b && c.outside && F + d > ba && (ba = R + a));
          });
          b.forEach(function (b) {
            var a = b.x,
              d = b.anchorX,
            ...
            if (c.outside && a < d) {
              var m = R - F;
              0 < m &&
                (g || ((e.x = a + m), (e.anchorX = d + m)),
                g && ((e.x = (ba - F) / 2), (e.anchorX = d + m)));
            }
            b.tt.attr(e);
          });
          b = c.container;
          ...
          c.outside &&
            ...
            C &&
            ((g = V.getBBox()),
            C.setSize(g.width + g.x, g.height + g.y, !1),
            (b.style.left = F + "px"),
            (b.style.top = e + "px"));
        };
        ...
        a.prototype.tooltipFooterHeaderFormatter = function (b, a) {
          ...
          f(this, "headerFormatter", e, function (a) {
            g &&
              !l &&
              p(b.key) &&
              (l = g.getXDateFormat(b.key, c.dateTimeLabelFormats));
            g &&
              l &&
            ...
            a.text = v(r, { point: b, series: d }, this.chart);
          });
          return e.text;
        };
        ...
        a.prototype.updatePosition = function (b) {
          ...
          var l = (d.positioner || this.getPosition).call(
              this,
              e.width,
              e.height,
              b
    ...
    function (a, u, z, F, y) {
      ...
      u = (function () {
        ...
        g.prototype.applyOptions = function (b, a) {
          ...
          this.formatPrefix = (this.isNull = C(
            this.isValid && !this.isValid(),
            null === this.x || !p(this.y)
          ))
            ? "null"
            : "point";
        ...
        g.prototype.destroy = function () {
          ...
          c && c.enabled
            ? (this.animateBeforeDestroy(), r(b, f.duration))
            : b();
          e.pointCount--;
        };
        ...
        g.prototype.firePointEvent = function (b, a, e) {
          ...
          (g.point.events[b] ||
            (d.options && d.options.events && d.options.events[b])) &&
            d.importEvents();
          "click" === b &&
            g.allowPointSelect &&
            (e = function (b) {
        ...
        g.prototype.optionsToObject = function (b) {
          ...
          if (p(b) || null === b) l[c[0]] = b;
            ...
            for (
              ...
              b.length > e &&
              ((a = typeof b[0]),
              "string" === a ? (l.name = b[0]) : "number" === a && (l.x = b[0]),
              r++);
              h < e;

            )
              (d && "undefined" === typeof b[r]) ||
                (0 < c[h].indexOf(".")
                  ? g.prototype.setNestedProperty(l, b[r], c[h])
                  : (l[c[h]] = b[r])),
                r++,
                h++;
          else
        ...
        g.prototype.tooltipFormatter = function (b) {
          ...
          return A(b, { point: this, series: this.series }, a.chart);
        };
        g.prototype.update = function (b, a, c, e) {
          function d() {
            ...
            r.data[h] =
              B(r.data[h], !0) || B(b, !0) ? g.options : C(b, r.data[h]);
        ...
        g.prototype.setState = function (b, g) {
          ...
          if (
            !(
              ...
              !1 === m.enabled ||
              (b && (k || (r && !1 === h.enabled))) ||
              (b && n.states && n.states[b] && !1 === n.states[b].enabled)
            )
          ) {
            this.state = b;
            ...
            if (this.graphic && !this.hasDummyGraphic) {
              ...
              if (!t.styledMode) {
                ...
                d.options.inactiveOtherPoints &&
                  ...
                  this.connector &&
                    this.connector.animate({ opacity: J.opacity }, E));
                this.graphic.animate(J, E);
              }
              B &&
                this.graphic.animate(
                  B,
                  C(t.options.chart.animation, h.animation, f.animation)
                );
              v && v.hide();
            } else {
              if (b && h) {
                ...
                if (B)
                  if (v) v[g ? "animate" : "attr"]({ x: B.x, y: B.y });
                  else
                    l &&
                      ((d.stateMarkerGraphic = v =
                        t.renderer
                          .symbol(l, B.x, B.y, B.width, B.height)
                          .add(d.markerGroup)),
                      (v.currentSymbol = l));
                !t.styledMode &&
                  v &&
                  "inactive" !== this.state &&
                  v.attr(d.pointAttribs(this, b));
              }
              v &&
            ...
            m && m.size && v && "hidden" !== B && !this.isCluster
              ? (w || (d.halo = w = t.renderer.path().add(v.parentGroup)),
                w.show()[g ? "animate" : "attr"]({ d: this.haloPath(m.size) }),
                w.attr({
                  class:
                    "highcharts-halo highcharts-color-" +
                    C(this.colorIndex, d.colorIndex) +
      ...
      a = (function () {
          ...
          if (!C || !C.touch)
            if (
              ...
              (!c.hasCartesianSeries && !c.mapView) ||
                ...
                t ||
                C ||
                ((this.selectionMarker = C =
                  c.renderer
                    .rect(m, f, e ? 1 : h, d ? 1 : r, 0)
              ...
              C &&
                e &&
                ((e = q - k),
                C.attr({ width: Math.abs(e), x: (0 < e ? 0 : e) + k }));
              C &&
                d &&
                ((e = B - p),
                C.attr({ height: Math.abs(e), y: (0 < e ? 0 : e) + p }));
            ...
            if (this.hasDragged || g)
              b.axes.forEach(function (b) {
                if (
                  b.zoomEnabled &&
                  k(b.min) &&
                  (g || c[{ xAxis: "zoomX", yAxis: "zoomY" }[b.coll]]) &&
                  f(m) &&
                  f(r)
                ) {
                  var d = b.horiz,
        ...
        a.prototype.getChartCoordinatesFromPoint = function (a, c) {
          ...
          if (e && b) {
            ...
            return c
              ? { chartX: b.len + b.pos - h, chartY: e.len + e.pos - l }
              : { chartX: l + e.pos, chartY: h + b.pos };
          }
            ...
            e && !e.stickyTracking
              ...
              : b.filter(function (b) {
                  return f.filter
                    ...
                    : b.visible &&
                        !(!d && b.directTouch) &&
                        t(b.options.enableMouseTracking, !0) &&
                        b.stickyTracking;
                });
            ...
            (d && !e.noSharedTooltip
              ? ((r = b.filter(function (b) {
                ...
                r.forEach(function (b) {
                  ...
                  w(a) &&
                    (b.chart.isBoosting && (a = b.getPoint(a)), l.push(a));
                }))
              : l.push(k));
          f = { hoverPoint: k };
          h(this, "afterGetHoverData", f);
          return { hoverPoint: f.hoverPoint, hoverSeries: e, hoverPoints: l };
        };
        ...
        a.prototype.init = function (a, c) {
          ...
          this.lastValidTouch = {};
          z &&
            ((a.tooltip = new z(a, c.tooltip)),
            (this.followTouchMove = t(c.tooltip.followTouchMove, !0)));
          this.setDOMEvents();
        };
        a.prototype.normalize = function (a, c) {
          var b = a.touches,
            g = b
              ? b.length
                ? b.item(0)
                : t(b.changedTouches, a.changedTouches)[0]
              : a;
          ...
          b /= c.scaleX;
          g /= c.scaleY;
          return e(a, { chartX: Math.round(b), chartY: Math.round(g) });
        };
        a.prototype.onContainerClick = function (a) {
          ...
          c.cancelClick ||
            (b && this.inClass(a.target, "highcharts-tracker")
              ? (h(b.series, "click", e(a, { point: b })),
                c.hoverPoint && b.firePointEvent("click", a))
              : (e(a, this.getCoordinates(a)),
                c.isInsidePlot(a.chartX - g, a.chartY - d, {
                  visiblePlotOnly: !0,
                }) && h(c, "click", a)));
        };
        ...
        a.prototype.pinch = function (a) {
          ...
          1 < m
            ? (c.initiated = !0)
            : 1 === m && this.followTouchMove && (c.initiated = !1);
          ...
          "touchstart" === a.type
            ? ([].forEach.call(d, function (b, a) {
              ...
              b.axes.forEach(function (a) {
                if (a.zoomEnabled) {
                  var d = b.bounds[a.horiz ? "h" : "v"],
                    c = a.minPixelPadding,
                    e = a.toPixels(
                      Math.min(t(a.options.min, a.dataMin), a.dataMin)
                    ),
                    g = a.toPixels(
                      Math.max(t(a.options.max, a.dataMax), a.dataMax)
                    ),
                    m = Math.max(e, g);
              ...
              (c.res = !0))
            : c.followTouchMove && 1 === m
            ? this.runPointActions(c.normalize(a))
            : g.length &&
              (h(b, "touchpan", { originalEvent: a }, function () {
                q ||
                  (c.selectionMarker = q =
                    e({ destroy: H, touch: !0 }, b.plotBox));
        ...
        a.prototype.runPointActions = function (e, f) {
          ...
          f = this.getHoverData(
            ...
            b.series,
            (!e || "touchmove" !== e.type) &&
              (!!f || (l && l.directTouch && this.isDirectTouch)),
            d,
            e
          );
          m = f.hoverPoint;
          ...
          if (m && (m !== b.hoverPoint || (g && g.isHidden))) {
            ...
            f &&
              ...
              !g.isHidden &&
              ((m = g.getAnchor([{}], e)),
              b.isInsidePlot(m[0], m[1], { visiblePlotOnly: !0 }) &&
                g.updatePosition({ plotX: m[0], plotY: m[1] }));
          this.unDocMouseMove ||
            ((this.unDocMouseMove = A(
        ...
        a.prototype.scaleGroups = function (a, c) {
          ...
          b.series.forEach(function (e) {
            ...
            e.group &&
              ((e.xAxis && e.xAxis.zoomEnabled) || b.mapView) &&
              (e.group.attr(d),
              e.markerGroup &&
        ...
        a.prototype.setDOMEvents = function () {
          ...
          this.eventsToUnbind.push(
            A(e, "mouseenter", this.onContainerMouseEnter.bind(this))
          );
          this.eventsToUnbind.push(
            A(e, "mouseleave", this.onContainerMouseLeave.bind(this))
          );
          a.unbindDocumentMouseUp ||
            (a.unbindDocumentMouseUp = A(
              b,
              "mouseup",
          ...
          u.hasTouch &&
            (this.eventsToUnbind.push(
              A(e, "touchstart", this.onContainerTouchStart.bind(this), {
                passive: !1,
              })
            ),
            this.eventsToUnbind.push(
              A(e, "touchmove", this.onContainerTouchMove.bind(this), {
                passive: !1,
              })
            ),
            a.unbindDocumentTouchEnd ||
              (a.unbindDocumentTouchEnd = A(
                b,
                "touchend",
  ...
  M(
    ...
    function (a, u, z, F, y, G) {
      ...
      G = (function () {
        ...
        a.prototype.setOptions = function (b) {
          ...
          this.chart.styledMode ||
            ...
            (this.itemHiddenStyle = J(this.itemStyle, b.itemHiddenStyle)));
        ...
        a.prototype.colorizeItem = function (b, a) {
          ...
          B(this, "afterColorizeItem", { item: b, visible: a });
        };
        ...
        a.prototype.renderItem = function (b) {
          ...
          E ||
            ...
            (b.legendItem = E =
              c.text("", k ? e + g : -g, this.baseline || 0, q)),
            a.styledMode || E.css(J(b.visible ? f : h)),
            E.attr({ align: k ? "left" : "right", zIndex: 2 }).add(
              b.legendGroup
            ),
            this.baseline ||
              ...
              d.squareSymbol &&
                ...
                (r = this.symbolWidth + g + l + (t ? 20 : 0)),
                k && E.attr("x", this.symbolWidth + g))),
            n.drawLegendSymbol(this, b),
            this.setItemEvents && this.setItemEvents(b, E, q));
          t &&
            !b.checkbox &&
          ...
          b.itemWidth = b.checkboxOffset =
            d.itemWidth || b.legendItemWidth || a.width + r;
        ...
        a.prototype.layoutItem = function (b) {
          ...
          this.offsetWidth =
            this.widthOption ||
            Math.max(
              (d ? this.itemX - c - (b.checkbox ? 0 : h) : a) + c,
              this.offsetWidth
            );
        };
        a.prototype.getAllItems = function () {
          ...
          this.chart.series.forEach(function (a) {
            var c = a && a.options;
            a &&
              C(c.showInLegend, f(c.linkedTo) ? !1 : void 0, !0) &&
              (b = b.concat(
        ...
        a.prototype.handleOverflow = function (b) {
          ...
          l && (g = Math.min(g, l));
          r.length = 0;
          b && 0 < g && b > g && !1 !== k.enabled
            ? ((this.clipHeight = E =
                Math.max(g - 20 - this.titleHeight - h, 0)),
              ...
              v ||
                ((v = a.clipRect = d.clipRect(0, h, 9999, 0)),
              ...
              N ||
                ...
                c.styledMode || this.pager.css(k.style),
                this.pager.add(N),
        ...
        a.prototype.scroll = function (a, c) {
          ...
          0 < p &&
            ...
            (this.scrollOffset = -g[p - 1] + this.initialItemY),
            this.scrollGroup.animate({ translateY: this.scrollOffset }),
            (this.currentPage = p),
            this.positionCheckboxes(),
            (a = v(C(c, e.renderer.globalAnimation, !0))),
            b(function () {
      ...
      (/Trident\/7\.0/.test(z.navigator && z.navigator.userAgent) || a) &&
        y(G.prototype, "positionItem", function (b, a) {
          var c = this,
            d = function () {
      ...
      a = (function () {
        ...
        a.prototype.init = function (b, a) {
          ...
          Q(this, "init", { args: arguments }, function () {
            ...
            this.series = [];
            this.time =
              b.time && Object.keys(b.time).length ? new c(b.time) : y.time;
        ...
        a.prototype.isInsidePlot = function (b, a, c) {
          ...
          h = c.inverted ? a : b;
          a = c.inverted ? b : a;
          b = { x: h, y: a, isInsidePlot: !0 };
          if (!c.ignoreX) {
            var p = (m && (d ? m.yAxis : m.xAxis)) || { pos: g, len: Infinity };
            h = c.paneCoordinates ? p.pos + h : g + h;
            (h >= Math.max(l + g, p.pos) &&
              h <= Math.min(l + g + e.width, p.pos + p.len)) ||
              (b.isInsidePlot = !1);
          }
          !c.ignoreY &&
            b.isInsidePlot &&
          ...
          if (b)
            for (; a && a.style; )
              a.hcOrigStyle && (O(a, a.hcOrigStyle), delete a.hcOrigStyle),
                a.hcOrigDetached &&
                  (r.body.removeChild(a), (a.hcOrigDetached = !1)),
                (a = a.parentNode);
          else
            for (; a && a.style; ) {
              r.body.contains(a) ||
                a.parentNode ||
                ((a.hcOrigDetached = !0), r.body.appendChild(a));
        ...
        a.prototype.getContainer = function () {
          ...
          this.renderer = new (
            c.renderer || !b ? n.getRendererType(c.renderer) : e
          )(
            d,
            l,
            k,
        ...
        a.prototype.reflow = function (b) {
          ...
          if (!e && !a.isPrinting && f && c && (d === g || d === r)) {
            if (f !== a.containerWidth || c !== a.containerHeight)
              h.clearTimeout(a.reflowTimeout),
                (a.reflowTimeout = ba(
                  function () {
        ...
        a.prototype.setReflow = function (b) {
          ...
          !1 === b || this.unbindReflow
            ...
            : ((this.unbindReflow = x(g, "resize", function (b) {
        ...
        a.prototype.setChartSize = function (b) {
          ...
          this.plotWidth = m = Math.max(
            0,
            Math.round(d - l - this.marginRight)
          );
          ...
          this.plotBox = c.plotBox = { x: l, y: k, width: m, height: p };
          ...
          this.clipBox = {
            ...
            height: Math.max(
              0,
              Math.floor(this.plotSizeY - Math.max(a, h[2]) / 2 - e)
            ),
          };
          b ||
        ...
        a.prototype.drawChartBox = function () {
          ...
          if (e) var x = (B = q.strokeWidth());
            ...
            f = { fill: f || "none" };
            if (x || q["stroke-width"])
              (f.stroke = b.borderColor), (f["stroke-width"] = x);
          ...
          N[C](E);
          e ||
            (N.attr({ fill: h || "none" }).shadow(b.plotShadow),
            l &&
              (g
                ? (l !== g.attr("href") && g.attr("href", l), g.animate(E))
                : (this.plotBGImage = a.image(l, k, m, p, n).add())));
          r
          ...
          w[C](w.crisp({ x: k, y: m, width: p, height: n }, -w.strokeWidth()));
          this.isDirtyBox = !1;
        ...
        a.prototype.addSeries = function (b, a, c) {
          ...
          b &&
            ((a = R(a, !0)),
            Q(d, "addSeries", { options: b }, function () {
              e = d.initSeries(b);
              d.isDirtyLegend = !0;
              d.linkSeries();
        ...
        a.prototype.update = function (b, a, d, e) {
          ...
          b.time &&
            (this.time === m && (this.time = new c(b.time)),
            W(!0, g.options.time, b.time));
          X(b, function (a, c) {
          ...
          p || (T(E) && E !== g.chartWidth) || (T(n) && n !== g.chartHeight)
            ? g.setSize(E, n, e)
            : R(a, !0) && g.redraw(e);
          Q(g, "afterUpdate", { options: b, redraw: a, animation: e });
        };
        ...
        a.prototype.showResetZoom = function () {
          ...
          Q(this, "beforeShowResetZoom", null, function () {
            a.resetZoomButton = a.renderer
              .button(c.resetZoom, null, null, b, g, f && f.hover)
          ...
          Q(this, "pan", { originalEvent: b }, function () {
            ...
            a.forEach(function (a) {
              if (a.options.panningEnabled && !a.options.isInternal) {
                ...
                p = Math.min(
                  R(q && q.startMin, n.dataMin),
                  m ? n.min : a.toValue(a.toPixels(n.min) - a.minPixelPadding)
                );
                r = Math.max(
                  R(q && q.startMax, n.dataMax),
                  m ? n.max : a.toValue(a.toPixels(n.max) + a.minPixelPadding)
                );
                a.panningState = q;
                a.isOrdinal ||
                  ((m = p - k),
                  ...
                  a.series.length &&
                    ...
                    k >= p &&
                    E <= r &&
                    (a.setExtremes(k, E, !1, !1, { trigger: "pan" }),
                    c.resetZoomButton ||
                      g ||
                      k === p ||
                      E === r ||
    ...
    (function (a) {
      a.drawLineMarker = function (a) {
        ...
        h &&
          !1 !== h.enabled &&
          A &&
          ((u = Math.min(z(h.radius, n), n)),
          0 === this.symbol.indexOf("url") &&
            ((h = v(h, { width: q, height: q })), (u = 0)),
          (this.legendSymbol = A =
            k
              .symbol(this.symbol, A / 2 - u, a - u, 2 * u, 2 * u, h)
    ...
    function (a, u, z, F, y, G, H, A, q, n) {
      ...
      a = (function () {
        ...
        a.prototype.setOptions = function (a) {
          ...
          a = Y(a);
          b = b.styledMode;
          var h = { plotOptions: e, userOptions: a };
          I(this, "setOptions", h);
              ...
              if (
                ...
                -1 === m || "undefined" === typeof m
                  ...
                  ? (e[m].update(a, !1, null, !1),
                    ...
                    h && (p = m + 1))
                  : e[m] && (e[m].touched = !0),
                !l || b !== m || (d && d.enabled) || this.hasDerivedData)
              )
                k = !0;
            } else f.push(a);
          }, this);
        ...
        a.prototype.getProcessedData = function (a) {
          ...
          for (d = h.length || 1; --d; )
            if (
              ((b = c ? a(h[d]) - a(h[d - 1]) : h[d] - h[d - 1]),
              0 < b && ("undefined" === typeof q || b < q))
            )
              var q = b;
          ...
          for (p = 0; p < g; p++) {
            ...
            if (h) {
              ...
              t.dataGroup.options &&
                ...
                D(t, t.dataGroup.options),
                delete t.dataLabels);
            } else
              (t = n[r]) ||
                "undefined" === typeof b[r] ||
                (n[r] = t = new e().init(this, b[r], c[p]));
        ...
        a.prototype.getExtremes = function (a, b) {
          ...
          for (h = 0; h < p; h++) {
            ...
            r =
              ...
              ((e[h + f] || r) >= l && (e[h - f] || r) <= k);
            if (t && r)
              if ((t = n.length)) for (; t--; ) O(n[t]) && (g[m++] = n[t]);
              else g[m++] = n;
          }
          a = { activeYData: g, dataMin: C(g), dataMax: v(g) };
          ...
          for (w = 0; w < k; w++) {
            var x = l[w],
              ...
              y =
                ...
                h.stacking &&
                h.stacking.stacks[
                  (this.negStacks && J < (t ? 0 : n) ? "-" : "") + this.stackKey
                ];
            if (
              ...
              x.isNull = !0;
            x.plotX = B = b(
              r(d.translate(v, 0, 0, 0, 1, m, "flags" === this.type), -1e5, 1e5)
            );
            ...
            S(D) &&
              ((A = D[0]),
              (J = D[1]),
              A === t && z.key === y[v].base && (A = K(O(n) && n, h.min)),
              h.positiveValuesOnly && 0 >= A && (A = null),
              (x.total = x.stackTotal = u.total),
              (x.percentage = u.total && (x.y / u.total) * 100),
              (x.stackY = J),
            ...
            x.plotY = void 0;
            O(J) &&
              ((u = h.translate(J, !1, !0, !1, !0)),
              "undefined" !== typeof u && (x.plotY = r(u, -1e5, 1e5)));
        ...
        a.prototype.drawPoints = function () {
          ...
          if (!1 !== c.enabled || this._hasPointMarkers)
            for (f = 0; f < a.length; f++) {
              ...
              var p = !!l.marker;
              if (
                ((g && "undefined" === typeof m.enabled) || m.enabled) &&
                !l.isNull &&
                !1 !== l.visible
              ) {
                ...
                this.enabledDataSorting &&
                  (l.startXPos = e.reversed ? -(r.width || 0) : e.width);
                var t = !1 !== l.isInside;
                h
                  ? h[t ? "show" : "hide"](t).animate(r)
                  : t &&
                    (0 < (r.width || 0) || l.hasImage) &&
                    ((l.graphic = h =
                      b.renderer
                        .symbol(n, r.x, r.y, r.width, r.height, p ? m : c)
                        .add(d)),
                    this.enabledDataSorting &&
                      b.hasRendered &&
                      (h.attr({ x: l.startXPos }), (k = "animate")));
                h && "animate" === k && h[t ? "show" : "hide"](t).animate(r);
                if (h && !b.styledMode)
                  h[k](this.pointAttribs(l, l.selected && "select"));
        ...
        a.prototype.pointAttribs = function (a, b) {
          ...
          a = K(
            b.lineWidth,
            c.lineWidth,
            a + K(b.lineWidthPlus, c.lineWidthPlus, 0)
          );
        ...
        a.prototype.destroy = function (a) {
          ...
          (b.axisTypes || []).forEach(function (a) {
            (k = b[a]) &&
              k.series &&
              (d(k.series, b), (k.isDirty = k.forceRedraw = !0));
          });
        ...
        a.prototype.applyZones = function () {
          ...
          if (d.length && (g || f) && l && "undefined" !== typeof l.min) {
            ...
            d.forEach(function (d, E) {
              ...
              x = Math.max(m, p);
              l.isXAxis
                ? ((n = { x: k ? x : q, y: 0, width: t, height: h }),
                  u || (n.x = b.plotHeight - n.x))
                : ((n = { x: 0, y: k ? x : q, width: h, height: t }),
                  u && (n.y = b.plotWidth - n.y));
              k &&
                c.isVML &&
                (n = l.isXAxis
                  ? { x: 0, y: v ? q : x, height: n.width, width: b.chartWidth }
                  : {
        ...
        a.prototype.invertGroups = function (a) {
          ...
          var c = this,
            d = c.chart;
          c.xAxis &&
            (c.eventsToUnbind.push(t(d, "resize", b)),
            b(),
            (c.invertGroups = b));
        };
        ...
        a.prototype.drawTracker = function () {
          var a = this,
            ...
            p = "rgba(192,192,192," + (w ? 0.0001 : 0.002) + ")";
          m
            ? m.attr({ d: d })
            : a.graph &&
              ((a.tracker = h
        ...
        a.prototype.addPoint = function (a, b, c, d, e) {
          ...
          c &&
            (f[0] && f[0].remove
              ? f[0].remove(!1)
              : (f.shift(), this.updateParallelArrays(n, "shift"), m.shift()));
        ...
        a.prototype.update = function (a, b) {
          ...
          q &&
            ...
            a.data &&
              (a.dataSorting && D(c.options.dataSorting, a.dataSorting),
          ...
          if (B[t]) {
            if (((f = t !== c.type), c.remove(!1, !1, !1, !0), f))
              if (Object.setPrototypeOf)
                Object.setPrototypeOf(c, B[t].prototype);
              else {
        ...
        a.prototype.setState = function (a, b) {
          ...
          if (
            ...
            a &&
              ((l = f[a].lineWidth || l + (f[a].lineWidthPlus || 0)),
              (m = K(f[a].opacity, m)));
            if (e && !e.dashstyle)
              for (
                d = { "stroke-width": l }, e.animate(d, h);
                c["zone-graph-" + k];
        ...
        if (!this.renderer.forExport) {
          if (e) {
            if (
              ...
              this.scrollablePlotBox = this.renderer.scrollablePlotBox = n(
                this.plotBox
              );
  ...
  M(
    ...
    function (a, u, z) {
      ...
      (function (a) {
        ...
        a.compose = function (a) {
          -1 === h.indexOf(a) &&
            (h.push(a), y(a, "init", c), y(a, "destroy", e));
          return a;
        };
        var f = (function () {
          function a(a) {
    ...
    function (a, u, z, F, y, G, H) {
        ...
        w = (function () {
          function a(a, c, e, f, h) {
            ...
            this.alignOptions = {
              ...
              verticalAlign:
                c.verticalAlign || (l ? "middle" : e ? "bottom" : "top"),
              y: c.y,
              x: c.x,
            };
            this.textAlign =
              c.textAlign || (l ? (e ? "right" : "left") : "center");
          }
          a.prototype.destroy = function () {
            k(this, this.axis);
          };
          a.prototype.render = function (a) {
            ...
            this.label
              ...
              : ((this.label = c.renderer.label(
                ...
                c.styledMode ||
                  ((h.fill = e.backgroundColor),
                  (h.stroke = e.borderColor),
          ...
          a.prototype.setOffset = function (a, e, h, k, p) {
            var l = this.axis,
              b = l.chart;
            k = l.translate(
              l.stacking.usePercentage ? 100 : k ? k : this.total,
              0,
              0,
              0,
              1
            ...
            e &&
              ...
              f(!a && this.options.crop, !0) &&
                ((b =
                  c(e.x) &&
                  c(e.y) &&
                  b.isInsidePlot(e.x - k + e.width, e.y) &&
                  b.isInsidePlot(e.x + k, e.y)) ||
                  e.hide()));
          };
      ...
      y.prototype.setGroupedPoints = function () {
        ...
        1 < this.chart.series.length
          ? y.prototype.setStackedPoints.call(this, "group")
          : a &&
            h(a.stacks, function (c, e) {
              "group" === e.slice(-5) &&
                (h(c, function (a) {
                  return a.destroy();
                }),
      ...
      y.prototype.setStackedPoints = function (a) {
        ...
        if (
          ...
          for (y = 0; y < r; y++) {
            ...
            x[K][z] ||
              (u[K] && u[K][z]
                ? ((x[K][z] = u[K][z]), (x[K][z].total = null))
                : (x[K][z] = new w(v, v.options.stackLabels, A, z, l)));
            K = x[K][z];
            null !== F
              ? ((K.points[G] = K.points[this.index] = [f(K.cumulative, g)]),
                n(K.cumulative) || (K.base = G),
                (K.touched = v.stacking.stacksTouched),
                0 < H.index &&
                  !1 === this.singleStacks &&
                  (K.points[G][0] = K.points[this.index + "," + z + ",0"][0]))
              : (K.points[G] = K.points[this.index] = null);
            "percent" === c
              ? ((A = A ? a : d),
                m && x[A] && x[A][z]
                  ? ((A = x[A][z]),
                    (K.total = A.total =
                      Math.max(A.total, K.total) + Math.abs(F) || 0))
                  : (K.total = q(K.total + (Math.abs(F) || 0))))
              : "group" === c
              ? (e(F) && (F = F[0]),
                null !== F && (K.total = (K.total || 0) + 1))
              : (K.total = q(K.total + (F || 0)));
            K.cumulative =
              "group" === c
                ? (K.total || 1) - 1
                : f(K.cumulative, g) + (F || 0);
            null !== F &&
              (K.points[G].push(K.cumulative),
              (p[y] = K.cumulative),
              (K.hasValidPoints = !0));
          }
        ...
        a[k + "Stacker"] &&
          [c, "-" + c].forEach(function (c) {
            for (var b = f.length, g, d; b--; )
              if (
                ((g = f[b]),
                (h = a.getStackIndicator(h, g, a.index, c)),
                (d = (g = e[c] && e[c][g]) && g.points[h.key]))
              )
                a[k + "Stacker"](d, g, b);
          });
      };
    ...
    function (a, u, z) {
      ...
      z = (function (u) {
        ...
        A.prototype.drawGraph = function () {
          ...
          c.forEach(function (c, f) {
            var h = c[0],
              ...
              q = p ? "animate" : "attr";
            p
              ? ((p.endX = a.preventGraphAnimation ? null : k.xMap),
                p.animate({ d: k }))
              : k.length &&
                (a[h] = p =
                  a.chart.renderer
        ...
        A.prototype.getGraphPath = function (a, n, k) {
          ...
          var v = a.reversed;
          v && a.reverse();
          (p = { right: 1, center: 2 }[p] || (p && 3)) && v && (p = 4 - p);
  ...
  M(
    ...
    function (a, u, z, F) {
        ...
        e.prototype.drawGraph = function () {
          ...
          k.forEach(function (a) {
            var h = a[0],
              ...
              q = {};
            k
              ? ((k.endX = c.preventGraphAnimation ? null : e.xMap),
                k.animate({ d: e }))
              : ((q.zIndex = 0),
                (k = c[h] =
            ...
            c.chart.styledMode ||
              (q.fill = n(
                a[3],
                G(a[2]).setOpacity(n(f.fillOpacity, 0.75)).get()
              ));
            k[p](q);
            k.startX = e.xMap;
        ...
        e.prototype.getGraphPath = function (a) {
          ...
          for (q = 0; q < a.length; q++) {
            ...
            if (!d || e)
              e || g(q, q - 1, "left"),
                (d && !k && e) ||
                  (v.push(a[q]), t.push({ x: q, plotX: m, plotY: D })),
                e || g(q, q + 1, "right");
          }
          q = c.call(this, v, !0, !0);
          t.reversed = !0;
      ...
      a(F.prototype, { singleStacks: !1, drawLegendSymbol: u.drawRectangle });
      ...
      u = (function (a) {
        ...
        u.prototype.getPointSpline = function (a, n, k) {
          ...
          if (
            ...
            t += q;
            v > a && v > c
              ? ((v = Math.max(a, c)), (t = 2 * c - v))
              : v < a && v < c && ((v = Math.min(a, c)), (t = 2 * c - v));
            t > k && t > c
              ? ((t = Math.max(k, c)), (v = 2 * c - t))
              : t < k && t < c && ((t = Math.min(k, c)), (v = 2 * c - t));
            n.rightContX = f;
            n.rightContY = t;
          }
          n = [
    ...
    function (a, u, z, F, y, G, H) {
      ...
      H = (function (a) {
        ...
        l.prototype.animate = function (a) {
          ...
          if (a)
            (k.scaleY = 0.001),
              (a = e(c.toPixels(h.threshold), c.pos, c.pos + c.len)),
              l ? (k.translateX = a - c.len) : (k.translateY = a),
              b.clipBox && b.setClip(),
              b.group.attr(k);
          else {
            ...
            b.group.animate(
              ...
              f(q(b.options.animation), {
                step: function (a, d) {
                  b.group &&
                    ((k[n] = p + d.pos * (c.pos - p)), b.group.attr(k));
                },
              })
            );
          }
        ...
        l.prototype.getColumnMetrics = function () {
          ...
          c = Math.min(
            ...
            J(c.pointWidth, r * (1 - 2 * c.pointPadding))
          );
          a.columnMetrics = {
            width: c,
            offset:
              (r - c) / 2 +
              (p + ((a.columnIndex || 0) + (f ? 1 : 0)) * r - n / 2) *
                (f ? -1 : 1),
            paddedWidth: r,
            columnCount: k,
          };
        ...
        l.prototype.crispCol = function (a, c, d, e) {
          ...
          this.options.crisp &&
            ((d = Math.round(a + d) + f), (a = Math.round(a) + f), (d -= a));
          e = Math.round(c + e) + g;
          f = 0.5 >= Math.abs(c) && 0.5 < e;
          c = Math.round(c) + g;
          e -= c;
          f && e && (--c, (e += 1));
            ...
            C(this.yAxis.stacking && this.yAxis.stacking.stacks, function (a) {
              if ("number" === typeof d.x && (a = a[d.x.toString()])) {
                var c = a.points[b.index],
                  e = a.total;
                g
                  ? (c && (f = h), a.hasValidPoints && h++)
                  : p(c) && ((f = c[1]), (h = e || 0));
              }
            });
            a =
              (d.plotX || 0) +
              ((h - 1) * e.paddedWidth + c) / 2 -
              c -
              f * e.paddedWidth;
          }
          return a;
        ...
        l.prototype.translate = function () {
          ...
          a.points.forEach(function (b) {
            ...
            r &&
              Math.abs(D) < r &&
              ((D = r),
              (m = (!k.reversed && !b.negative) || (k.reversed && b.negative)),
              B(n) &&
                B(w) &&
                b.y === n &&
                w <= n &&
                ...
                (u !== w || (k.max || 0) <= n) &&
                (m = !m),
              (x = Math.abs(x - p) > r ? g - r : p - (m ? r : 0)));
            h(b.options.pointWidth) &&
              ((y = z = Math.ceil(b.options.pointWidth)),
              (A -= Math.round((y - t) / 2)));
            ...
            b.tooltipPos = c.inverted
              ? [
                  e(
                    k.len + k.pos - c.plotLeft - f,
                    k.pos - c.plotLeft,
                    k.len + k.pos - c.plotLeft
                  ),
        ...
        l.prototype.pointAttribs = function (a, c) {
          ...
          c &&
            ...
            (h =
              a.color ||
              ("undefined" !== typeof c && n(h).brighten(a.brightness).get()) ||
              h),
            (l = a[g] || l),
            (k = a[f] || k),
            (e = a.dashStyle || e),
            (p = J(a.opacity, p)));
          g = { fill: h, stroke: l, "stroke-width": k, opacity: p };
          e && (g.dashstyle = e);
          return g;
        };
            ...
            if (B(b.plotY) && null !== b.y) {
              ...
              a.enabledDataSorting &&
                (b.startXPos = a.xAxis.reversed
                  ...
                  : a.xAxis.width);
              g ||
                ((b.graphic = g = e[b.shapeType](h).add(b.group || a.group)) &&
                  a.enabledDataSorting &&
                  c.hasRendered &&
                  c.pointCount < f &&
                  (g.attr({ x: b.startXPos }), (l = !0), (k = "animate")));
              if (g && l) g[k](t(h));
              if (d.borderRadius) g[k]({ r: d.borderRadius });
              c.styledMode ||
                g[k](a.pointAttribs(b, b.selected && "select")).shadow(
                  !1 !== b.allowShadow && d.shadow,
                  null,
        ...
        l.prototype.drawTracker = function () {
          var a = this,
            ...
            f = function (a) {
              ...
              "undefined" !== typeof b &&
                ((d.isDirectTouch = !0), b.onMouseOver(a));
            },
            h;
          ...
          a._hasTracking ||
            (a.trackerGroups.forEach(function (b) {
              if (a[b]) {
                ...
                !e.styledMode &&
                  a.options.cursor &&
                  a[b].css(c).css({ cursor: a.options.cursor });
              }
            }),
            (a._hasTracking = !0));
      ...
      (function (a) {
          ...
          var g = this,
            ...
            w =
              ...
              (a.series.forceDL ||
                (k && !u) ||
                t ||
                (e(c.inside, !!this.options.stacking) &&
                  d &&
                  h.isInsidePlot(m, l ? d.x + 1 : d.y + d.height - 1, {
                    inverted: l,
                    paneCoordinates: !0,
                    series: g,
                  })));
          if (w) {
            var C = h.renderer.fontMetrics(
            ...
            H(c, { width: p.width, height: p.height });
            r
              ? ((u = !1),
                (m = h.renderer.rotCorr(C, r)),
                (m = {
                ...
                v(m),
                b[f ? "attr" : "animate"](m).attr({ align: q }),
                (v = (r + 720) % 360),
                (v = 180 < v && 360 > v),
                "left" === q
                  ? (m.y -= v ? p.height : 0)
                ...
                (b.placed = !0),
                (b.alignAttr = m))
              : (v(d), b.align(c, void 0, d), (m = b.alignAttr));
            u && 0 <= d.height
              ? this.justifyDataLabel(b, c, m, p, d, f)
              : e(c.crop, !0) &&
                (w =
        ...
        function u() {
          var a = this,
            ...
            r,
            t = p.animation;
          t = p.defer ? v(b, t, a) : { defer: 0, duration: 0 };
          p = z(
            z(
              ...
              b.options.plotOptions &&
                b.options.plotOptions[a.type] &&
                b.options.plotOptions[a.type].dataLabels
            ),
            p
          );
          ...
          if (q(p) || p.enabled || a._hasPointLabels) {
            ...
            !f &&
              (f = a.dataLabelsGroup) &&
              (a.visible && u.show(!0),
              f[g.animation ? "animate" : "attr"]({ opacity: 1 }, t));
            d.forEach(function (d) {
              r = c(z(p, d.dlOptions || (d.options && d.options.dataLabels)));
              r.forEach(function (c, f) {
                var l =
                    c.enabled && (!d.isNull || d.dataLabelOnNull) && h(d, c),
                ...
                if (l) {
                  ...
                  t = G(v)
                    ? y(v, t, b)
                    : (c[d.formatPrefix + "Formatter"] || c.formatter).call(
                        t,
                        c
                      );
                  v = c.style;
                  ...
                  b.styledMode ||
                    ...
                    "contrast" === v.color
                      ? ((d.contrastColor = n.getContrast(d.color || a.color)),
                        (v.color =
                          (!G(r) && c.inside) || 0 > r || g.stacking
                            ? d.contrastColor
                            : "#000000"))
                      : delete d.contrastColor,
                    g.cursor && (v.cursor = g.cursor));
                  var C = {
                    r: c.borderRadius || 0,
                    rotation: w,
                    padding: c.padding,
                  ...
                  b.styledMode ||
                    ((C.fill = c.backgroundColor),
                    (C.stroke = c.borderColor),
                    (C["stroke-width"] = c.borderWidth));
                  k(C, function (a, b) {
                    "undefined" === typeof a && delete C[b];
                  });
                }
                !p ||
                  (l && G(t) && !!p.div === !!c.useHTML) ||
                  ((d.dataLabel = p = d.dataLabel && d.dataLabel.destroy()),
                  d.dataLabels &&
                    (1 === d.dataLabels.length
                      ? delete d.dataLabels
                      : delete d.dataLabels[f]),
                  f || delete d.dataLabel,
                  m &&
                    ((d.connector = d.connector.destroy()),
                    d.connectors &&
                      (1 === d.connectors.length
                        ? delete d.connectors
                        : delete d.connectors[f])));
                l &&
                  G(t) &&
                  (p
                    ? (C.text = t)
                  ...
                  (p.options = c),
                  p.attr(C),
                  b.styledMode || p.css(v).shadow(c.shadow),
                  p.added || p.add(u),
                  c.textPath &&
                    !c.useHTML &&
                    (p.setTextPath(
                      (d.getDataLabelPath && d.getDataLabelPath(p)) ||
                        d.graphic,
                      c.textPath
                    ),
                    d.dataLabelPath &&
    ...
    function (a, u, z) {
      ...
      (function (a) {
        ...
        a.getStartAndEndRadians = function (a, k) {
          ...
          return { start: v * (a + -90), end: v * (k + -90) };
        };
      })(A || (A = {}));
      ("");
      return A;
    ...
    function (a, u, z, F, y, G, H, A, q) {
      ...
      q = (function (a) {
        ...
        c.prototype.getX = function (a, c, f) {
          ...
          return (
            h[0] +
            (c ? -1 : 1) * Math.cos(a) * (b + f.labelDistance) +
            (0 < f.labelDistance
          ...
          a.points.forEach(function (l) {
            ...
            if (!l.isNull && g) {
              ...
              c.styledMode ||
                ...
                h &&
                  !n &&
                  (n = l.shadowGroup = e.g("shadow").add(a.shadowGroup)),
                n && n.attr(b),
                (d = a.pointAttribs(l, l.selected && "select")));
              l.delayedRendering
                ? (g.setRadialReference(a.center).attr(k).attr(b),
                  c.styledMode ||
                    g.attr(d).attr({ "stroke-linejoin": "round" }).shadow(h, n),
                  (l.delayedRendering = !1))
                : (g.setRadialReference(a.center),
                  c.styledMode || f(!0, m, d),
                  f(!0, m, k, b),
                  g.animate(m));
        ...
        c.prototype.translate = function (a) {
          ...
          for (q = 0; q < n; q++) {
            ...
            u.tooltipPos = [a[0] + 0.7 * B, a[1] + 0.7 * A];
            ...
            u.labelPosition = {
              ...
              connectorPosition: {
                ...
                touchingSliceAt: { x: a[0] + B, y: a[1] + A },
              },
            };
          }
        ...
        c.prototype.updateTotals = function () {
          ...
          for (f = 0; f < c; f++)
            (g = a[f]),
              (g.percentage = 0 < b && (g.visible || !e) ? (g.y / b) * 100 : 0),
              (g.total = b);
        };
      ...
      (function (f) {
              ...
              if (l) {
                ...
                if (0 < a.maxLabelDistance) {
                  ...
                  e.forEach(function (a) {
                    0 < a.labelDistance &&
                      a.dataLabel &&
                      ((a.top = Math.max(0, w - u - a.labelDistance)),
                      (a.bottom = Math.min(
                        w + u + a.labelDistance,
                        b.plotHeight
                      )),
                ...
                for (X = 0; X < l; X++) {
                  ...
                  m &&
                    ...
                    ("undefined" === typeof z.distributeBox.pos
                      ? (W = "hidden")
                      : ((T = z.distributeBox.size),
                        (V = B.radialDistributionY(z))));
                  ...
                  c(g.crop, !0) &&
                    ...
                    N - M < d && 1 === f
                      ...
                      : N + M > h - d &&
                        0 === f &&
                        ((q = Math.round(N + M - h + d)),
                        (y[1] = Math.max(q, y[1]))),
                    0 > V - T / 2
                      ? (y[0] = Math.max(Math.round(-V + T / 2), y[0]))
                      : V + T / 2 > n &&
                        (y[2] = Math.max(Math.round(V + T / 2 - n), y[2])),
                    (J.sideOverflow = q));
                }
              }
            }),
            0 === q(y) || this.verifyDataLabelOverflow(y)) &&
        ...
        function t(a) {
          ...
          if (!f) {
            if (null !== e[0]) var k = Math.max(c[2] - Math.max(a[1], a[3]), d);
              ...
              (k = Math.max(c[2] - a[1] - a[3], d)),
                (c[0] += (a[3] - a[1]) / 2);
            null !== e[1]
              ? (k = n(k, d, c[2] - Math.max(a[0], a[2])))
              : ((k = n(k, d, c[2] - a[0] - a[2])),
                (c[1] += (a[0] - a[2]) / 2));
            k < c[2]
              ? ((c[2] = k),
                (c[3] = Math.min(h(b.innerSize || 0, k), k)),
                this.translate(c),
        ...
        f.compose = function (c) {
          ...
          -1 === w.indexOf(c) &&
            (w.push(c),
            (c = c.prototype),
            (c.dataLabelPositioners = C),
            (c.alignDataLabel = v),
            (c.drawDataLabels = p),
            (c.placeDataLabels = u),
            (c.verifyDataLabelOverflow = t));
        };
      })(f || (f = {}));
      return f;
    }
      ...
      var e = (function () {
          ...
          function c(a, f, h, k) {
            ...
            H(a, function (a, d) {
              if (!k && -1 < e.collectionsWithUpdate.indexOf(d) && f[d])
                for (
                  a = q(a), h[d] = [], b = 0;
                  b < Math.max(a.length, f[d].length);
                  b++
                )
                  f[d][b] &&
                    (void 0 === a[b]
                      ? (h[d][b] = f[d][b])
                      : ((h[d][b] = {}), c(a[b], f[d][b], h[d][b], k + 1)));
              else
                y(a)
                  ? ((h[d] = F(a) ? [] : {}), c(a, f[d] || {}, h[d], k + 1))
        ...
        a.prototype.matchResponsiveRule = function (a, c) {
          ...
          (
            ...
            function () {
              return (
                this.chartWidth <= A(e.maxWidth, Number.MAX_VALUE) &&
                this.chartHeight <= A(e.maxHeight, Number.MAX_VALUE) &&
                this.chartWidth >= A(e.minWidth, 0) &&
                this.chartHeight >= A(e.minHeight, 0)
              );
            }
