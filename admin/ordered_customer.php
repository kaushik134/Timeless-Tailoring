                  ...
                  <div class="col-12">
                    <div class="card">
                      <div class="card-header">
                        <h4 class="card-title">ordered customer</h4>
                      </div>
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
                      <?php 
                      $qry="select * from customer_tbl,order_detail_tbl,cart_tbl where order_detail_tbl.cart_id=cart_tbl.cart_id 
					  AND cart_tbl.customer_id=customer_tbl.customer_id group by customer_tbl.customer_id ";
