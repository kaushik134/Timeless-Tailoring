          ...
          <div class="navbar-collapse" id="navbar-mobile">
            ...
            <ul class="nav navbar-nav float-right">
              ...
              <li class="dropdown dropdown-user nav-item"><a class="dropdown-toggle nav-link dropdown-user-link" href="javascript:void(0);" data-toggle="dropdown">
                  <div class="user-nav d-sm-flex d-none"><span class="user-name"><?php echo $_SESSION['name']; ?></span><span class="user-status text-muted">Available</span></div><span><img class="round" src="profiles/<?php echo $_SESSION['photo']; ?>" alt="avatar" height="40" width="40"></span></a> 
                <div class="dropdown-menu dropdown-menu-right pb-0"><a class="dropdown-item" href="edit_profile.php?upid=<?php echo $_SESSION['id']; ?>"><i class="bx bx-user mr-50"></i> Edit Profile</a><a class="dropdown-item" href="change_password.php"><i class="bx bxs-key"></i> Change Password</a>
