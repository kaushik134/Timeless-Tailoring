...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  header('location:index.php');
	...
	$qry1="select * from bottom_tbl";
	$result=mysqli_query($cnn,$qry1);
	$img=$bname=$price=$extra_instruction='';
	 if(!empty($_GET['up_id']))
	 {
		  $str1="select * from bottom_tbl";
		  $result1=mysqli_query($cnn,$str1);
		  $str="select * from bottom_tbl where bottom_id=".$_GET['up_id'];
	      $result=mysqli_query($cnn,$str);
		  $res=mysqli_fetch_array($result);
      
		  $bname=$res['bottom_name'];
		  $price=$res['bottom_price'];
      $img=$res['bottom_image'];
	...
	{	
		...
		if(!empty($_GET['up_id']))
		{
			...
			$bottom_status=1; 
			$str="update bottom_tbl set bottom_name='".$_POST['bname']."',bottom_image='".$image."',bottom_price='".$_POST['price']."',extra_instruction='".$_POST['extra_instruction']."'where bottom_id=".$_GET['up_id'];
     ...
     // echo "hii"; die;
			$bottom_status=1;
			$qry2="insert into bottom_tbl values(NULL,'".$_POST['bname']."','".$image."','".$_POST['price']."','".$_POST['extra_instruction']."','".$bottom_status."') ";
		//	echo $qry2; die;
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Bottom | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Bottom</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Bottom
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <option selected disabled>Select Category</option>
			       ...
			       <div class="form-group">
              <label class="form-label" for="basic-default-name"> Bottom name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="bname" 
                placeholder="bottom name" value="<?php echo $bname;?>"
              />
            </div>
            
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Bottom Image</label>
            ...
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Bottom price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="bottom price" value="<?php echo $price;?>"
              />
            </div>
            <div class="form-group">
