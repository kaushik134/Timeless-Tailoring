...
<body
  class="vertical-layout vertical-menu-modern boxicon-layout no-card-shadow 2-columns  navbar-sticky footer-static dark-layout  "
      ...
      <div class="content-body">
        ...
        <label class="radio-inline"><input type="radio" name="optradio" value="Female">Female</label> 
                    ...
                    <div class="form-group">
                      ...
                      <input type="text" class="form-control" id="basic-default-name" name="cname"
                        placeholder="category Name" value="<?php echo $cname; ?>" />
                    </div>
                    <div class="form-group">
                      <label class="form-label" for="basic-default-name"> Category Type</label>
                      <select class="form-control" id="basic-default-name" name="ctype">
                        <option selected disabled>category Type</option>
                        <option <?php if ($ctype == "top") {
                          echo 'selected';
                        } ?>>top</option>
                        <option <?php if ($ctype == "full") {
                          echo 'selected';
                        } ?>>top and bottom</option>
                        <option <?php if ($ctype == "bottom") {
                          echo 'selected';
                        } ?>>bottom</option>
                      </select>
