        ...
        a(t, [
          {
            ...
            value: function () {
              ...
              (this.lgRect = this.dimHelpers.getLegendsRect()),
                t.axisCharts
                  ? this.setDiwomensionsForAxisCharts()
                  : this.setDiwomensionsForNonAxisCharts(),
          ...
          {
            key: "setDiwomensionsForAxisCharts",
            value: function () {
              var t = this,
                e = this.w,
                i = e.globals,
          ...
          {
            key: "setDiwomensionsForNonAxisCharts",
            value: function () {
              var t = this.w,
                e = t.globals,
                i = t.config,
    ...
    Mt = (function () {
      ...
      return (
        a(t, [
          ...
          {
            key: "recalcDiwomensionsBasedOnFormat",
            value: function (t, e) {
              var i = this.w,
    ...
    Et = (function () {
      ...
      return (
        a(t, [
          ...
          {
            key: "setSVGDiwomensions",
            value: function () {
              var t = this.w.globals,
                e = this.w.config;
              (t.svgWidth = e.chart.width), (t.svgHeight = e.chart.height);
              var i = f.getDiwomensions(this.el),
                a = e.chart.width
                  .toString()
                  .split(/[0-9]+/g)
                  .pop();
              if (
                ("%" === a
                  ? f.isNumber(i[0]) &&
                    (0 === i[0].width &&
                      (i = f.getDiwomensions(this.el.parentNode)),
                ...
                if (
                  ...
                  var s = f.getDiwomensions(this.el.parentNode);
              ...
              if (e.globals.axisCharts) {
                ...
                if (
                  ...
                  !e.globals.isBarHorizontal
                    ...
                    this.ctx.timeScale.recalcDiwomensionsBasedOnFormat(i);
                }
        ...
        a(t, [
          {
            ...
            value: function () {
              (this.ctx.publicMethods = [
                ...
                (this.ctx.diwomensions = new nt(this.ctx)),
