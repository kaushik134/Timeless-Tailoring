...
!(function (e) {
  ...
  function i(e) {
    var t,
      ...
      i,
      s = e.className + " ";
    if (((s += e.parentNode ? e.parentNode.className : ""), (r = E.exec(s))))
  ...
  function o(e, a, n) {
    ...
    for (var l = 0, u = "", d = []; e.length || a.length; ) {
      var b = i();
      if (
        ((u += t(n.substr(l, b[0].offset - l))), (l = b[0].offset), b === e)
      ) {
        d.reverse().forEach(c);
  ...
  function u(e, r, n, i) {
    ...
    function h(e, t) {
      ...
      if (a) {
        ...
        do N.cN && (C += B), N.skip || (M += N.r), (N = N.parent);
        while (N !== a.parent);
    ...
    try {
      ...
      if ($.message && -1 !== $.message.indexOf("Illegal"))
  ...
  function m(e) {
    ...
    n(m) ||
      ...
      (a.value = b(a.value)),
      (e.innerHTML = a.value),
      (e.className = p(e.className, m, a.language)),
