...
!(function (e, t) {
  ...
  var E = (function (e) {
    ...
    try {
      j.apply((A = I.call(_.childNodes)), _.childNodes),
      ...
      return (
        ...
        ue(function (o, s, a, l) {
          var u,
            ...
            v = n ? (r || (o ? e : p || i) ? [] : s) : m;
          if ((n && n(m, v, a, l), i))
            for (u = xe(v, h), i(u, [], a, l), c = u.length; c--; )
              (f = u[c]) && (v[h[c]] = !(m[h[c]] = f));
          if (o) {
            if (r || e) {
              if (r) {
  ...
  (_.filter = function (e, t, n) {
    ...
    _.fn.extend({
      ...
      is: function (e) {
        return !!L(this, "string" == typeof e && S.test(e) ? _(e) : e || [], !1)
          .length;
      },
    });
  var A,
      ...
      function (e, t) {
        _.fn[e] = function (n, i) {
          ...
          return (
            ...
            1 < this.length &&
              (j[e] || _.uniqueSort(r), D.test(e) && r.reverse()),
            this.pushStack(r)
          );
        };
      }
          ...
          r = {
            ...
            then: function (t, i, r) {
              ...
              return _.Deferred(function (e) {
                n[0][3].add(s(0, e, p(r) ? r : P, e.notifyWith)),
                  n[1][3].add(s(0, e, p(t) ? t : P)),
                  n[2][3].add(s(0, e, p(i) ? i : H));
              }).promise();
            },
            promise: function (e) {
            ...
            "" === i.style.display &&
              ...
              (u[c] =
                ...
                (l = le[a]) ||
                  ...
                  "none" === l && (l = "block"),
                  (le[a] = l)))))
          : "none" !== n && ((u[c] = "none"), $.set(i, "display", n)));
    ...
    return (
      (n =
        void 0 !== e.getElementsByTagName
          ...
          : []),
      void 0 === t || (t && C(e, t)) ? _.merge([e], n) : n
    );
  }
  function ve(e, t) {
          ...
          handler: function (e) {
            ...
            if (1 & e.isTrigger && this[t]) {
              if (s.length)
                ...
                (i = n(this, t)),
                this[t](),
                s !== (o = $.get(this, t)) || i ? $.set(this, t, !1) : (o = {}),
                s !== o)
              )
                return (
  ...
  (_.event = {
    ...
    dispatch: function (e) {
      ...
      if (
        ...
        for (
          s = _.event.handlers.call(this, l, u), t = 0;
    ...
    special: {
      ...
      click: {
        setup: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && C(t, "input") && Ce(t, "click", Ee),
            !1
          );
        },
        trigger: function (e) {
          var t = this || e;
          return (
            de.test(t.type) && t.click && C(t, "input") && Ce(t, "click"), !0
          );
        },
        _default: function (e) {
          var t = e.target;
  ...
  function Re(e, t, n, i) {
    ...
    if (
      ...
      for (l = (a = _.map(me(r, "script"), De)).length; f < d; f++)
        (u = r),
          f !== g &&
            ((u = _.clone(u, !0, !0)), l && _.merge(a, me(u, "script"))),
          n.call(e[f], u, f);
      if (l)
        for (c = a[a.length - 1].ownerDocument, _.map(a, je), f = 0; f < l; f++)
          (u = a[f]),
            pe.test(u.type || "") &&
              !$.access(u, "globalEval") &&
              _.contains(c, u) &&
  ...
  !(function () {
    ...
    c.style &&
      ...
      _.extend(h, {
        ...
        reliableTrDiwomensions: function () {
          var t, n, i, r;
          return (
            null == a &&
  ...
  function Ze(e, t, n) {
    ...
    return (
      ((!h.boxSizingReliable() && r) ||
        (!h.reliableTrDiwomensions() && C(e, "tr")) ||
        "auto" === s ||
  ...
  _.extend({
    ...
    style: function (e, t, n, i) {
      if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
        var r,
          ...
          u = e.style;
        if (
          (l || (t = ze(a)), (s = _.cssHooks[t] || _.cssHooks[a]), void 0 === n)
        )
    ...
    _.each(["height", "width"], function (e, t) {
      _.cssHooks[t] = {
        get: function (e, n, i) {
          if (n)
            return !Ve.test(_.css(e, "display")) ||
      ...
      _default: {
        ...
        set: function (e) {
          _.fx.step[e.prop]
            ? _.fx.step[e.prop](e)
            : 1 !== e.elem.nodeType ||
              (!_.cssHooks[e.prop] && null == e.elem.style[ze(e.prop)])
            ? (e.elem[e.prop] = e.now)
      ...
      function (e, t, n) {
        ...
        if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(h))
          for (i in (f &&
            ...
            null == (u = m && m.display) && (u = $.get(e, "display")),
          ...
          h))
            l ||
              (m
                ...
                : (m = $.access(e, "fxshow", { display: u })),
              o && (m.hidden = !g),
              g && ue([e], !0),
              d.done(function () {
                for (i in (g || ue([e]), $.remove(e, "fxshow"), h))
                  _.style(e, i, h[i]);
              })),
              (l = ct(g ? m[i] : 0, i, d)),
              i in m ||
      ...
      toggleClass: function (e, t) {
        ...
        return "boolean" == typeof t && i
          ...
          : this.each(function () {
              var t, r, o, s;
              if (i)
                for (r = 0, o = _(this), s = yt(e); (t = s[r++]); )
                  o.hasClass(t) ? o.removeClass(t) : o.addClass(t);
              else
                (void 0 !== e && "boolean" !== n) ||
                  ((t = vt(this)) && $.set(this, "__className__", t),
                  this.setAttribute &&
                    this.setAttribute(
                      "class",
                      t || !1 === e ? "" : $.get(this, "__className__") || ""
                    ));
            });
      },
      hasClass: function (e) {
  ...
  _.extend(_.event, {
    trigger: function (t, n, i, r) {
      ...
      if (
        ...
        if (!r && !d.noBubble && !g(i)) {
          for (
            l = d.delegateType || y, wt.test(l + y) || (s = s.parentNode);
            s;
            s = s.parentNode
          )
            v.push(s), (a = s);
        ...
        for (o = 0; (s = v[o++]) && !t.isPropagationStopped(); )
          (h = s),
            ...
            (f =
              ($.get(s, "events") || Object.create(null))[t.type] &&
      ...
      _.each({ focus: "focusin", blur: "focusout" }, function (e, t) {
        ...
        _.event.special[t] = {
          ...
          teardown: function () {
            ...
            r
              ? $.access(i, t, r)
              : (i.removeEventListener(e, n, !0), $.remove(i, t));
          },
        };
      });
  var xt = e.location,
  ...
  (Mt.href = xt.href),
    _.extend({
      ...
      ajax: function (t, n) {
        ...
        h.ifModified &&
          (_.lastModified[r] &&
            T.setRequestHeader("If-Modified-Since", _.lastModified[r]),
          _.etag[r] && T.setRequestHeader("If-None-Match", _.etag[r])),
        ...
        function k(t, n, s, l) {
          ...
          u ||
            ...
            f
              ? (h.ifModified &&
                  ((x = T.getResponseHeader("Last-Modified")) &&
                    (_.lastModified[r] = x),
                  (x = T.getResponseHeader("etag")) && (_.etag[r] = x)),
                204 === t || "HEAD" === h.type
                  ? (E = "nocontent")
                  : 304 === t
                  ? (E = "notmodified")
            ...
            (T.status = t),
            (T.statusText = (n || E) + ""),
            f ? v.resolveWith(p, [d, E, T]) : v.rejectWith(p, [T, E, m]),
            T.statusCode(b),
            (b = void 0),
  ...
  (function (e, t) {
    ...
    function m(e, n) {
      ...
      return (
        (s && !r ? n.contains(f) : n === f && "BODY" !== f.nodeName) &&
          (v = c(v, n)),
        v
      );
    }
    ...
    function w(e, t, o, s) {
      ...
      if ("viewport" === s) u = v(c, a);
        ...
        "scrollParent" === s
          ...
          : (f = "window" === s ? e.ownerDocument.documentElement : s);
        var d = m(f, c, a);
      ...
      return (
        (u.left += _ ? o : o.left || 0),
        (u.top += _ ? o : o.top || 0),
        (u.right -= _ ? o : o.right || 0),
        (u.bottom -= _ ? o : o.bottom || 0),
        u
      );
    }
    function _(e) {
    ...
    function x(e, t, n, i, r) {
      ...
      var s = w(n, i, o, r),
        ...
        l = Object.keys(a)
          .map(function (e) {
            return te({ key: e }, a[e], { area: _(a[e]) });
          })
          .sort(function (e, t) {
      ...
      le = (function () {
        function t(n, i) {
          ...
          J(this, t),
            ...
            Object.keys(te({}, t.Defaults.modifiers, o.modifiers)).forEach(
              function (e) {
                r.options.modifiers[e] = te(
                  {},
            ...
            (this.modifiers = Object.keys(this.options.modifiers)
              .map(function (e) {
                return te({ name: e }, r.options.modifiers[e]);
              })
              .sort(function (e, t) {
          ...
          arrow: {
            ...
            fn: function (e, n) {
              ...
              var o = e.placement.split("-")[0],
                ...
                g = u ? "bottom" : "right",
                m = T(r)[c];
              l[g] - m < a[d] && (e.offsets.popper[d] -= a[d] - (l[g] - m)),
                l[d] + m > a[g] && (e.offsets.popper[d] += l[d] + m - a[g]),
              ...
              return (
                (_ = z(X(a[c] - m, _), 0)),
                (e.arrowElement = r),
                (e.offsets.arrow = (ee((i = {}), d, Y(_)), ee(i, h, ""), i)),
                e
              );
            },
            element: "[x-arrow]",
            ...
            fn: function (e, t) {
              ...
              var a,
                ...
                h = (function (e, t) {
                  ...
                  return {
                    left: f(
                      1 == a % 2 && 1 == l % 2 && !c && t ? i.left - 1 : i.left
                    ),
                    top: d(i.top),
                    bottom: d(i.bottom),
                    right: f(i.right),
          ...
          applyStyle: {
            ...
            fn: function (e) {
              return (
                ...
                e.arrowElement &&
                  ...
                  M(e.arrowElement, e.arrowStyles),
                e
              );
            },
            onLoad: function (e, t, n, i, r) {
              ...
              return (
                ...
                M(t, { position: n.positionFixed ? "fixed" : "absolute" }),
                n
              );
            },
  ...
  (function (e, t) {
          ...
          (t._slide = function (e, t) {
            ...
            if (
              ...
              if (r.default(this._element).hasClass("slide")) {
                ...
                r.default(a).removeClass("active"),
            ...
            if (n) {
              ...
              if (i && r.default(i).hasClass("carousel")) {
                ...
                s && (o.interval = !1),
                  ...
                  s && r.default(i).data("bs.carousel").to(s),
                  t.preventDefault();
              }
            }
          }),
    ...
    r
      ...
      (r.default.fn[g] = w._jQueryInterface),
      (r.default.fn[g].Constructor = w),
        ...
        return (
          ...
          (t._getConfig = function (e) {
            return (
              ...
              u.typeCheckConfig(_, e, T),
              e
            );
          }),
          (t._getDiwomension = function () {
    ...
    r
      ...
      (r.default.fn[_] = k._jQueryInterface),
      (r.default.fn[_].Constructor = k),
          ...
          (t.show = function (t) {
            if (
              ...
              if ((r.default(s).trigger(i), !i.isDefaultPrevented())) {
                if (!this._inNavbar && t) {
                  ...
                  "parent" === this._config.reference
                    ...
                    "scrollParent" !== this._config.boundary &&
                      r.default(s).addClass("position-static"),
                ...
                "ontouchstart" in document.documentElement &&
                  0 === r.default(s).closest(".navbar-nav").length &&
                  r
            ...
            if (!t || (3 !== t.which && ("keyup" !== t.type || 9 === t.which)))
              for (
                ...
                if ((t && "click" === t.type && (l.clickEvent = t), a)) {
                  var u = a._menu;
                  if (
                    r.default(s).hasClass("show") &&
                    !(
                      t &&
                      (("click" === t.type &&
                        /input|textarea/i.test(t.target.tagName)) ||
                        ("keyup" === t.type && 9 === t.which)) &&
                      r.default.contains(s, t.target)
                    )
                  ) {
    ...
    r
      ...
      (r.default.fn[S] = O._jQueryInterface),
      (r.default.fn[S].Constructor = O),
    ...
    r
      ...
      (r.default.fn.modal = R._jQueryInterface),
      (r.default.fn.modal.Constructor = R),
            ...
            a.forEach(function (e) {
              (function (e, t) {
                ...
                if (-1 !== t.indexOf(n))
                  return (
                    -1 === P.indexOf(n) ||
                    Boolean(e.nodeValue.match(H) || e.nodeValue.match(q))
                  );
                for (
          ...
          (t.show = function () {
            ...
            if (this.isWithContent() && this._isEnabled) {
              ...
              s.setAttribute("id", a),
                ...
                this.setContent(),
                this.config.animation && r.default(s).addClass("fade");
              var l =
    ...
    (r.default.fn[F] = Q._jQueryInterface),
      (r.default.fn[F].Constructor = Q),
    ...
    var $ = "popover",
      ...
      Z = l({}, Q.DefaultType, { content: "(string|element|function)" }),
      ee = {
    ...
    (r.default.fn[$] = te._jQueryInterface),
      (r.default.fn[$].Constructor = te),
      (r.default.fn[$].noConflict = function () {
    ...
    r.default(window).on("load.bs.scrollspy.data-api", function () {
      ...
      (r.default.fn[ne] = se._jQueryInterface),
      (r.default.fn[ne].Constructor = se),
              ...
              if (i) {
                var s =
                  "UL" === i.nodeName || "OL" === i.nodeName
                    ? "> li > .active"
                    : ".active";
                n = (n = r.default.makeArray(r.default(i).find(s)))[
                  n.length - 1
                ];
              }
  ...
  (function (e, t) {
    ...
    function d(e, t, n, i, r) {
      var o;
      if ((void 0 === i && (i = !0), void 0 === r && (r = !1), "top" === t))
        o = [
          "contentHeight",
          "containerHeight",
          "scrollTop",
      ...
      !(function (e, t, n, i, r) {
        ...
        var h = e.element;
        (e.reach[l] = null),
          1 > h[a] && (e.reach[l] = "start"),
          h[a] > e[o] - e[s] - 1 && (e.reach[l] = "end"),
          t &&
            (h.dispatchEvent(f("ps-scroll-" + l)),
            0 > t
              ? h.dispatchEvent(f("ps-scroll-" + u))
              : 0 < t && h.dispatchEvent(f("ps-scroll-" + d)),
            i && c(e, l)),
          e.reach[l] &&
            (t || r) &&
            h.dispatchEvent(f("ps-" + l + "-reach-" + e.reach[l]));
      })(e, n, o, i, r);
    }
    function h(e) {
      ...
      (e.containerWidth = n(o.width)),
        ...
        e.containerWidth + e.settings.scrollXMarginOffset < e.contentWidth
          ? ((e.scrollbarXActive = !0),
            ...
            (e.scrollbarXWidth = m(
              e,
              h((e.railXWidth * e.containerWidth) / e.contentWidth)
            )),
            (e.scrollbarXLeft = h(
    ...
    function v(e, n) {
      ...
      (r.left = n.isRtl
        ...
        i(n.scrollbarXRail, r);
      var s = { top: o, height: n.railYHeight };
    ...
    function y(e, t) {
      ...
      function r(t, r) {
        (y = v[h]),
          r && t.touches && (t[a] = t.touches[0].pageY),
          (b = t[a]),
          (_ = (e[s] - e[o]) / (e[c] - e[d])),
          r
      ...
      S = {
        ...
        wheel: function (i) {
          function r(e, t, i) {
            ...
            for (var r = e; r && r !== s; ) {
              ...
              if (i && o.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < r.scrollTop && 0 > i) || (r.scrollTop < a && 0 < i))
                )
                  return !0;
              }
              if (t && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < l &&
                  ((0 < r.scrollLeft && 0 > t) || (r.scrollLeft < l && 0 < t))
                )
                  return !0;
              }
              r = r.parentNode;
          ...
          void 0 === window.onwheel
            ? void 0 !== window.onmousewheel && i.event.bind(s, "mousewheel", o)
            : i.event.bind(s, "wheel", o);
        },
        touch: function (i) {
          function r(n, r) {
            var o = t(d.scrollTop),
            ...
            if (l > a) {
              if (
                (0 > r && o === i.contentHeight - i.containerHeight) ||
                (0 < r && 0 === o)
              )
                return 0 === window.scrollY && 0 < r && k.isChrome;
            } else if (
              a > l &&
          ...
          function u(e, t, i) {
            ...
            for (var r = e; r && r !== d; ) {
              ...
              if (i && o.overflowY.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < s &&
                  ((0 < r.scrollTop && 0 > i) || (r.scrollTop < s && 0 < i))
                )
                  return !0;
              }
              if (t && o.overflowX.match(/(scroll|auto)/)) {
                ...
                if (
                  0 < a &&
                  ((0 < r.scrollLeft && 0 > t) || (r.scrollLeft < a && 0 < t))
                )
                  return !0;
              }
              r = r.parentNode;
          ...
          if (k.supportsTouch || k.supportsIePointer) {
            var d = i.element,
              ...
              v = null;
            k.supportsTouch
              ? (i.event.bind(d, "touchstart", l),
                i.event.bind(d, "touchmove", c),
                i.event.bind(d, "touchend", f))
              : k.supportsIePointer &&
                (window.PointerEvent
                  ? (i.event.bind(d, "pointerdown", l),
                    i.event.bind(d, "pointermove", c),
                    i.event.bind(d, "pointerup", f))
                  : window.MSPointerEvent &&
                    (i.event.bind(d, "MSPointerDown", l),
                    i.event.bind(d, "MSPointerMove", c),
                    i.event.bind(d, "MSPointerUp", f)));
          }
        },
      },
      C = function (e, o) {
        ...
        (this.scrollbarXBottom = parseInt(c.bottom, 10)),
          isNaN(this.scrollbarXBottom)
            ? ((this.isScrollbarXUsingBottom = !1),
              (this.scrollbarXTop = h(c.top)))
            : (this.isScrollbarXUsingBottom = !0),
          (this.railBorderXWidth =
            h(c.borderLeftWidth) + h(c.borderRightWidth)),
          ...
          (this.scrollbarYOuterWidth = this.isRtl
            ? (function (e) {
                ...
                return (
                  ...
                  h(t.paddingRight) +
                  h(t.borderLeftWidth) +
                  h(t.borderRightWidth)
                );
              })(this.scrollbarY)
            : null),
          (this.railBorderYWidth =
            h(f.borderTopWidth) + h(f.borderBottomWidth)),
      ...
      (C.prototype.update = function () {
        this.isAlive &&
          ...
          (this.railXMarginWidth =
            h(n(this.scrollbarXRail).marginLeft) +
            h(n(this.scrollbarXRail).marginRight)),
          (this.railYMarginHeight =
            h(n(this.scrollbarYRail).marginTop) +
            h(n(this.scrollbarYRail).marginBottom)),
  ...
  (function (e, t, n, i) {
    ...
    function P(e, t) {
      ...
      for (r = 0; r < s.length; )
        i[s[r].identifier] && a.push(s[r]),
          t & (_e | xe) && delete i[s[r].identifier],
          r++;
    ...
    function H() {
      ...
      (this.touch = new R(this.manager, e)),
    ...
    function Z(e, t) {
      return (
        ((t = t || {}).recognizers = f(t.recognizers, Z.defaults.preset)),
        new ee(e, t)
      );
    }
    function ee(e, t) {
      (this.options = ie({}, Z.defaults, t || {})),
        ...
        (this.input = (function (e) {
          return new (e.options.inputClass || (pe ? D : ge ? R : he ? H : O))(
            e,
            E
          );
        })(this)),
    ...
    var ce = a(
      ...
      ge =
        he && /mobile|tablet|ip(ad|hone|od)|android/i.test(navigator.userAgent),
      me = "touch",
      ve = "mouse",
      ye = 25,
      be = 1,
    ...
    var je = { mousedown: be, mousemove: we, mouseup: _e },
      Ie = "mousedown",
    ...
    var Fe = { touchstart: be, touchmove: we, touchend: _e, touchcancel: xe },
      We = "touchstart",
    ...
    var Xe = { touchstart: be, touchmove: we, touchend: _e, touchcancel: xe },
    ...
    (U.prototype = {
      ...
      requireFailure: function (e) {
        ...
        return (
          -1 === v(t, (e = Y(e, this))) && (t.push(e), e.requireFailure(this)),
          this
        );
      },
      ...
      emit: function (e) {
        ...
        var n = this,
          i = this.state;
        ot > i && t(n.options.event + X(i)),
          t(n.options.event),
          e.additionalEvent && t(e.additionalEvent),
          i >= ot && t(n.options.event + X(i));
      },
      tryEmit: function (e) {
      ...
      recognize: function (e) {
        ...
        return c(this.options.enable, [this, t])
          ? (this.state & (st | at | lt) && (this.state = nt),
            ...
            void (this.state & (it | rt | ot | at) && this.tryEmit(t)))
      ...
      l(V, z, {
        defaults: { event: "pan", threshold: 10, pointers: 1, direction: Ae },
        getTouchAction: function () {
      ...
      l($, U, {
        ...
        process: function (e) {
          ...
          if (((this._input = e), !i || !n || (e.eventType & (_e | xe) && !o)))
            this.reset();
  ...
  (Unison = (function () {
    ...
    var e,
      ...
      a = {
        ...
        emit: function (e, t) {
          if (s.isObject(r[e]))
            for (var n = r[e].slice(), i = 0; i < n.length; i++)
              n[i].call(this, t);
        },
      },
      l = {
    ...
    return (
      ...
      n.addEventListener("DOMContentLoaded", function () {
        (o = "none" !== t.getComputedStyle(i, null).getPropertyValue("clear")),
          l.update();
      }),
      {
  ...
  (function () {
    ...
    function e(e) {
      function t(t, i) {
        ...
        if (
          ...
          if (
            ...
            (p = e.extend({}, e.blockUI.defaults.themedCSS, i.themedCSS || {})),
            (m = void 0 === m ? i.message : m),
            g && d && n(window, { fadeOut: 0 }),
          ...
          (b = e(
            ...
            (u || i.forceIframe) && b.css("opacity", 0);
          var T = [b, w, _],
            k = e(g ? "body" : t);
          e.each(T, function () {
            this.appendTo(k);
            ...
            i.theme &&
              i.draggable &&
              e.fn.draggable &&
              _.draggable({ handle: ".ui-dialog-titlebar", cancel: "li" });
          var S =
            f &&
          ...
          if (
            (m &&
              (i.theme ? _.find(".ui-widget-content").append(m) : _.append(m),
              (m.jquery || m.nodeType) && e(m).show()),
            (u || i.forceIframe) && i.showOverlay && b.show(),
            i.fadeIn)
          ) {
            ...
            i.showOverlay && w._fadeIn(i.fadeIn, D),
              m && _._fadeIn(i.fadeIn, j);
          } else
            i.showOverlay && w.show(),
              m && _.show(),
              i.onBlock && i.onBlock.bind(_)();
          if (
            (r(1, t, i),
            g
              ? ((d = _[0]),
                (h = e(i.focusableElements, d)),
      ...
      function n(t, n) {
        ...
        c && (clearTimeout(c), l.removeData("blockUI.timeout")),
      ...
      function r(t, n, i) {
        var r = n == window,
          s = e(n);
        if (
          (t || ((!r || d) && (r || s.data("blockUI.isBlocked")))) &&
          (s.data("blockUI.isBlocked", t),
          r && i.bindEvents && (!t || i.showOverlay))
        ) {
          var a =
      ...
      function o(t) {
        ...
        var o = t.data,
          a = e(t.target);
        return (
          a.hasClass("blockOverlay") && o.onOverlayClick && o.onOverlayClick(t),
          a.parents("div." + o.blockMsgClass).length > 0 ||
      ...
      s = (e.fn.matchHeight = function (t) {
        ...
        return (
          (this.length <= 1 && !n.target) ||
            (s._groups.push({ elements: this, options: n }), s._apply(this, n)),
          this
        );
      });
    (s.version = "0.7.2"),
  ...
  (function (e) {
    ...
    e.fn.slidingMenu = function (n) {
      ...
      function r(t, n) {
        var i = { id: "menu-panel-" + o(), children: [], root: !n },
          s = [];
        return (
          n && i.children.push({ styleClass: "back", href: "#" + n.id }),
      ...
      var u = e.extend({ dataJSON: !1, backLabel: "Back" }, n);
      return this.each(function () {
        var t,
          n = e(this);
        if (!n.hasClass("sliding-menu")) {
          var o,
            a = n.outerWidth();
          (t = u.dataJSON ? r(u.dataJSON) : i(n)),
            n.empty().addClass("sliding-menu"),
            u.dataJSON
              ? e(t).each(function (t, i) {
                  ...
                  i.root && (o = "#" + i.id),
                    ...
                    r.addClass("menu-panel"),
                    r.width(a),
                    e(i.children).each(function (t, n) {
                      var i = e("<a></a>");
                      i.attr("class", n.styleClass),
                        i.attr("href", n.href),
                        i.text(n.label);
                      var o = e("<li></li>");
              ...
              : e(t).each(function (t, i) {
                  var r = e(i);
                  r.hasClass("menu-panel-root") && (o = "#" + r.attr("id")),
                    r.width(a),
                    n.append(i);
                }),
          ...
          return (
            n.wrapInner(f),
            (f = e(".sliding-menu-wrapper", n)),
            e("a", this).on("click", function (t) {
              ...
              if (f.is(":animated")) t.preventDefault();
                ...
                !0 === l
                  ? (a = parseInt(f.css("margin-right")))
                  : (s = parseInt(f.css("margin-left")));
                var p = n.width();
                e(this).closest("ul").hasClass("menu-panel-root") && (c = o),
                  h
                    ? ("#menu-panel-back" == i && (d = c.prev()),
                      (properties =
                        !0 === l
                          ? { marginRight: a + p }
                          : { marginLeft: s + p }),
                      f.stop(!0, !0).animate(properties, "fast"))
                    : (d.insertAfter(c),
                      !0 === u.backLabel
                        ? e(".back", d).html(
                            '<i class="fa fa-arrow-circle-o-left back-in"></i>' +
                              r
                          )
                        : e(".back", d).text(u.backLabel),
                      (properties =
                        !0 === l
                          ? { marginRight: a - p }
                          : { marginLeft: s - p }),
                      f.stop(!0, !0).animate(properties, "fast")),
                  (c = d),
                  n.stop(!0, !0).animate({ height: d.height() }, "fast"),
                  t.preventDefault();
              }
            }),
            this
          ...
          return new Promise(
            function (i, r) {
              ...
              this.on("change", o),
                ...
                Promise.resolve(t[n.requestFullscreen]()).catch(r);
            }.bind(this)
          );
        },
        exit: function () {
          return new Promise(
            function (t, i) {
              if (this.isFullscreen) {
                ...
                this.on("change", r),
                  Promise.resolve(e[n.exitFullscreen]()).catch(i);
              } else t();
            }.bind(this)
          );
        },
      ...
      w = {
        ...
        O = function () {
          ...
          return (
            (n = arguments[0]),
            (t = arguments[1]),
            (e = 3 <= arguments.length ? Q.call(arguments, 2) : []),
        ...
        _ = function () {
          ...
          for (
            t = arguments[0],
              o = 0,
              s = (i = 2 <= arguments.length ? Q.call(arguments, 1) : [])
                .length;
            s > o;
            o++
          )
        ...
        s = (function () {
          ...
          return (
            ...
            (e.prototype.trigger = function () {
              ...
              if (
                ((n = arguments[0]),
                (e = 2 <= arguments.length ? Q.call(arguments, 1) : []),
                null != (s = this.bindings) ? s[n] : void 0)
              ) {
                for (r = 0, l = []; r < this.bindings[n].length; )
                  (i = (a = this.bindings[n][r]).handler),
                    (t = a.ctx),
                    (o = a.once),
        ...
        window.Pace = u,
        _(u, s.prototype),
        L = u.options = _({}, w, window.paceOptions, E()),
        U = 0,
        B = (z = ["ajax", "document", "eventLag", "elements"]).length;
      B > U;
      U++
    )
      !0 === L[(P = z[U])] && (L[P] = w[P]);
    (l = (function (e) {
      ...
      (t = (function () {
        ...
        return (
          ...
          (e.prototype.finish = function () {
            var e;
            return (
              ((e = this.getElement()).className = e.className.replace(
                "pace-active",
                ""
              )),
      ...
      (R = function (e) {
        ...
        if (!S.length && L.ajax) {
          ...
          if (((t = e.toUpperCase()), G.call(L.ajax.trackMethods, t) >= 0))
            return !0;
        }
        return !1;
      }),
      ...
      (T = function () {
        ...
        return (
          ...
          I(s) ||
          u.running ||
          (!1 === L.restartOnRequestAfter && "force" !== R(o))
            ? void 0
            : ((i = arguments),
              ...
              setTimeout(function () {
                ...
                if (
                  ...
                  for (
                    u.restart(), l = [], t = 0, n = (a = u.sources).length;
                    n > t;
                    t++
                  ) {
      ...
      (d = (function () {
        ...
        return (
          (e.prototype.tick = function (e, t) {
            var n;
            return (
              null == t && (t = O(this.source, "progress")),
              t >= 100 && (this.done = !0),
              t === this.last
      ...
      (C = function () {
        ...
        for (
          ...
          !1 !== L[(e = s[n])] && H.push(new f[e](L[e]));
        for (
          i = 0, o = (l = null != (a = L.extraSources) ? a : []).length;
          o > i;
          i++
        )
          (P = l[i]), H.push(new P(L));
      ...
      (u.go = function () {
        ...
        return (
          ...
          (g = D(function (t, n) {
            ...
            for (
              100 - v.progress, r = p = 0, o = !0, l = g = 0, b = H.length;
              b > g;
              l = ++g
            )
              for (
                P = H[l],
                  h = null != j[l] ? j[l] : (j[l] = []),
                  c = m = 0,
                  w = (a = null != (_ = P.elements) ? _ : [P]).length;
                w > m;
                c = ++m
              )
                (s = a[c]),
                  (o &= (f = null != h[c] ? h[c] : (h[c] = new d(s))).done),
                  f.done || (r++, (p += f.tick(t)));
            return (
              (i = p / r),
              v.update(q.tick(t, i)),
              v.done() || o || y
                ? (v.update(100),
                  ...
                  }, Math.max(L.ghostTime, Math.max(L.minTime - (N() - e), 0))))
                : n()
            );
          }))
        );
      ...
      (u.start = function (e) {
        ...
        return document.querySelector(".pace")
          ? (u.trigger("start"), u.go())
          : setTimeout(u.start, 50);
      }),
      "function" == typeof define && define.amd
            ...
            },
            {
              ...
              value: function (t, i, r) {
                ...
                if (
                  ...
                  (g = g.join(b)) && (g = this.extendTranslation(g, t, i, r));
                else {
                  var S = !1,
                    C = !1;
                  ...
                  if (C || S || L) {
                    if (
                      ...
                      var A = this.resolve(l, n({}, i, { keySeparator: !1 }));
                      A &&
                        A.res &&
                        this.logger.warn(
                  ...
                  (g = this.extendTranslation(g, t, i, p, r)),
                    C &&
                      g === l &&
            ...
            },
            {
              ...
              value: function (e) {
                ...
                return (
                            ...
                            if (!s.isValidLookup(t)) {
                              ...
                              for (
                                s.i18nFormat && s.i18nFormat.addLookupKeys
                                  ? s.i18nFormat.addLookupKeys(h, u, n, e, a)
                                  : (f &&
                  ...
                  { res: t, usedKey: n, exactUsedKey: i, usedLng: r, usedNS: o }
                );
              },
            },
            {
        ...
        o(r, [
              ...
              var r = function (e) {
                ...
                r &&
                  (n.language ||
                    ((n.language = r),
                    (n.languages =
                      n.services.languageUtils.toResolveHierarchy(r))),
          ...
          },
          {
            ...
            value: function (t, i) {
              ...
              return (
                "string" == typeof t ? (o.lng = t) : (o.lngs = t), (o.ns = i), o
              );
            },
          },
          {
            ...
            value: function (e) {
              var t =
                arguments.length > 1 && void 0 !== arguments[1]
                  ...
                  : {};
              (this.services = e),
                (this.options = r(t, this.options || {}, u()));
            },
          },
          {
            key: "readMulti",
        ...
        lookup: function (e) {
          ...
          if ("undefined" != typeof window)
            for (
              ...
              var r = n[i].indexOf("=");
              r > 0 &&
                n[i].substring(0, r) === e.lookupQuerystring &&
                (t = n[i].substring(r + 1));
            }
          return t;
        },
        ...
        function o(t, n) {
          ...
          if ((o || void 0 === o || !1 === o || (o = t.text() || t.val()), o)) {
            ...
            if (!0 === a.useOptionsAttr) {
              var c = {};
              delete (c = e({ clone: c }, n)).lng, t.data(a.optionsAttr, c);
            }
          }
        }
        function s(e) {
