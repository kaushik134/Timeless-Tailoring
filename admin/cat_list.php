...
<head>
    ...
    <title>Category list | <?php echo $title;?></title>
        ...
        <div class="card-body card-dashboard">
          <div class="card-body card-dashboard">
                       ...
                       <!--  <?php if(isset($_SESSION['update'])) { ?>            
                          <div class="alert alert-update alert-dismissible">
                                <a href="#" class="close" data-dismiss="alert" aria-label="close">&times;</a>
                        <strong>Danger!</strong> <?php echo $_SESSION['update'];  
          ...
          <div class="table-responsive">
            <table class="table table-striped dataex-html5-selectors dataTable">
              ...
              <tbody>
                <a href="cat_add.php" class="add_cat"> 
                             <button value="Add Category" class="btn btn-primary" style="margin: 45px 0px -86px;font-size: 13px;">
        ...
        while($result=mysqli_fetch_array($test))
        {
          ?>
           ...
           <!-- <td><img style="border-radius:100px;" src="profiles/<?php echo $result['frontneck_image']; ?>" height="100px" width="100px"></td> -->
              ...
              <td>
                <?php if($result['category_status']==0) { ?>
                                     
                                     <a href="change_status.php?category_id=<?php echo $result['category_id'];?>&category_status=<?php echo $result['category_status'];?>"> 
                                  ...
                                  <?php }?>
                                      ...
                                      <?php if($result['category_status']==0) {echo "<span class='text-danger'>Inactive</span>";} else { echo "<span class='text-success'>Active</span>";}  ?>
              </td>
            <td><a href="cat_delete.php?del=<?php echo $result['category_id'];?>" onclick="return confirm('Are you sure you want to delete?')">
                <div class="fonticon-wrap">
