...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $qry1="select * from piping_tbl";
  $result=mysqli_query($cnn,$qry1);
  $pname=$price=$img='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from piping_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from piping_tbl where piping_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $pname=$res['piping_name'];
      $price=$res['piping_price'];
      $img=$res['piping_image'];
    }
  if(isset($_POST['sbtn']))
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $piping_status=1; 
      $str="update piping_tbl set piping_name='".$_POST['pname']."',piping_image='".$image."',piping_price='".$_POST['price']."'where piping_id=".$_GET['up_id'];
      //echo $str;die;
	    $_SESSION['success']="piping update Successfully...";
    ...
    { 
     // echo "hii"; die;
      $piping_status=1;
      $qry2="insert into piping_tbl values(NULL,'".$_POST['pname']."','".$image."','".$_POST['price']."','".$tassles_status."') ";
    //  echo $qry2; die;
      //mysqli_query($cnn,$qry2);
      $piping_success=mysqli_query($cnn,$qry2);
          if($piping_success)
          {
            $_SESSION['success']="Piping Added Successfully...";
          }
          else
           {
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Piping | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Piping</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Piping
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <label class="radio-inline"><input type="radio" name="optradio" value="Female">Female</label> 
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Piping name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="pname" 
                placeholder="Piping name" value="<?php echo $pname;?>"
              />
            </div>
      <div class="form-group">
              <label class="form-label" for="basic-default-name"> Piping Image</label>
          ...
          <img src="profiles/<?php echo $img;?>" height="60px" width="60px"  
            ...
            <br>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Piping price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Piping price" value="<?php echo $price;?>"
              />
            </div>
     ...
     <script type="text/javascript">
      ...
      $(document).ready(function() {
          $("#custom_val").validate({
                ...
                messages : {
                      pname: {
                      required: "Piping name should be at least 3 characters"
                    }
                }
