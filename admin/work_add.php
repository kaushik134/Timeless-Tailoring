...
require_once('connect.php');
 ...
 if(!isset($_SESSION['admin_email']))
 {
  ...
  $qry1="select * from tassles_tbl";
  $result=mysqli_query($cnn,$qry1);
  $wname=$price=$img='';
   if(!empty($_GET['up_id']))
   {
      $str1="select * from work_tbl";
      $result1=mysqli_query($cnn,$str1);
      $str="select * from work_tbl where work_id=".$_GET['up_id'];
        $result=mysqli_query($cnn,$str);
      $res=mysqli_fetch_array($result);
      $wname=$res['work_name'];
      $price=$res['work_price'];
      $img=$res['work_image'];
    }
  if(isset($_POST['sbtn']))
  { 
    ...
    if(!empty($_GET['up_id']))
    {
      ...
      $work_status=1; 
      $str="update work_tbl set work_name='".$_POST['wname']."',work_image='".$image."',work_price='".$_POST['price']."'where work_id=".$_GET['up_id'];
      //echo $str;die;
	    $_SESSION['success']="work update Successfully...";
    ...
    { 
     // echo "hii"; die;
      $work_status=1;
      $qry2="insert into work_tbl values(NULL,'".$_POST['wname']."','".$image."','".$_POST['price']."','".$work_status."') ";
    //  echo $qry2; die;
      //mysqli_query($cnn,$qry2);
      $work_success=mysqli_query($cnn,$qry2);
          if($work_success)
          {
...
<!-- /index.html by,  04:41:56 GMT -->
  <head>
    ...
    <title> Add Work | <?php echo $title;?></title>
        ...
        <div class="content-header row">
          <div class="content-header-left col-12 mb-2 mt-1">
            <div class="breadcrumbs-top">
              <h5 class="content-header-title float-left pr-1 mb-0">Work</h5>
              <div class="breadcrumb-wrapper d-none d-sm-block">
                <ol class="breadcrumb p-0 mb-0 pl-1">
                  ...
                  <li class="breadcrumb-item active">Add Work
                  </li>
                </ol>
              </div>
            </div>
    ...
    <div class="col-md-12">
      ...
      <form id="custom_val" enctype="multipart/form-data" method="POST">
        ...
        <label class="radio-inline"><input type="radio" name="optradio" value="Female">Female</label> 
             ...
             <div class="form-group">
              <label class="form-label" for="basic-default-name"> Work name</label>
              <input
                type="text"
                class="form-control"
                id="basic-default-name"
                name="wname" 
                placeholder="Work name" value="<?php echo $wname;?>"
              />
            </div>
      <div class="form-group">
              <label class="form-label" for="basic-default-name"> Work Image</label>
          ...
          <img src="profiles/<?php echo $img;?>" height="60px" width="60px"  
            ...
            <br>
            <div class="form-group">
              <label class="form-label" for="basic-default-name"> Work price</label>
              <input
                type="number"
                class="form-control"
                name="price" 
                placeholder="Work price" value="<?php echo $price;?>"
              />
            </div>
     ...
     <script type="text/javascript">
      ...
      $(document).ready(function() {
          $("#custom_val").validate({
                ...
                messages : {
                      wname: {
                      required: "Work name should be at least 3 characters"
                    }
                }
