...
<head>
    ...
    <title>Delivery Details | <?php echo $title;?></title>
                      ...
                      <div class="card-body card-dashboard">
                        ...
                        <div class="table-responsive">
                          <table class="table table-striped dataex-html5-selectors dataTable">
                            ...
                            <tbody>
                      <?php 
                      $qry="select * from delivery_method_tbl";
                      ...
                      while($result=mysqli_fetch_array($test))
                      {
                        ?>
                          <tr>
                            ...
                            </div> </button></a><?php echo $result['order_id'];?></td>         
                            <td><?php echo date("d-m-Y", strtotime($result['submitted_date']));?></td>
                            <td><?php echo $result['price'];?></td>
                            <!-- <td><?php echo $result['method_status'];?></td> -->
                            <td>
