  ...
  <div class="row">
    <div class="col-12">
      <div class="card">
        ...
        <?php 
        $qry="select * from feedback_tbl,customer_tbl where feedback_tbl.customer_id=customer_tbl.customer_id";
          ...
          ?>
           ...
           <!-- <td><img style="border-radius:100px;" src="profiles/<?php echo $result['lining_image']; ?>" height="100px" width="100px"></td> -->
              <td><?php echo $result['customer_name'];?>
                <!-- <button type="button" style="" id="customer" class="btn" data-id="<?php echo $result['customer_id'];?>" data-toggle="modal" data-target=".bs-example-modal-lg">
