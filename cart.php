					...
					<div class="table-responsive cart_table wow fadeInRight" data-wow-delay="0.2s">
						<table class="table">
							...
							if (!empty($_GET['cat_id'])) {
								...
								$str2 = "select * from category_tbl where category_id=" . $_GET['cat_id'];
								...
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $row_cart['style_image']; ?>" alt="image" class="img-responsive" />
										</span>
							...
							// $cart_id=$row_cart['cart_id'];
							// $output[] = $cart_id;
							// $cart_Total_amt=$data['lining_price']+$data['tassels_price']+$data['cups_price']+$data['piping_price']+$data['work_price'];
							if (isset($_SESSION['cart_total'])) {
								$_SESSION['cart_total'] += $cart_Total_amt;
							}
							$_SESSION['cart_id'] = $output;
							?>
							<?php if (isset($data['lining_id'])) { ?>
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $data['lining_image']; ?>" alt="image" class="img-responsive" />
										</span>
										<div class="product_details">
											<span class="prod_size"><b>Lining</b></span>
											<h4><b><?php echo $data['lining_name']; ?></b></h4>
										</div>

									<td>
										<h4>₹ <?php echo $data['lining_price']; ?></h4>
									</td>
								...
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $data['tassels_image']; ?>" alt="image" class="img-responsive" />
										</span>
										<div class="product_details">
											<span class="prod_size"><b>Tassels</b></span>
											<h4><b><?php echo $data['tassels_name']; ?></b></h4>
										</div>

									<td>
										<h4>₹ <?php echo $data['tassels_price']; ?></h4>
									</td>
								...
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $data['cups_image']; ?>" alt="image" class="img-responsive" />
										</span>
										<div class="product_details">
											<span class="prod_size"><b>Cups</b></span>
											<h4><b><?php echo $data['cups_name']; ?></b></h4>
										</div>

									<td>
										<h4>₹ <?php echo $data['cups_price']; ?></h4>
									</td>
								...
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $data['piping_image']; ?>" alt="image" class="img-responsive" />
										</span>
										<div class="product_details">
											<span class="prod_size"><b>Piping</b></span>
											<h4><b><?php echo $data['piping_name']; ?></b></h4>
										</div>

									<td>
										<h4>₹ <?php echo $data['piping_price']; ?></h4>
									</td>
								...
								<tr>
									<td>
										<span class="prod_thumb">
											<img src="admin/profiles/<?php echo $data['work_image']; ?>" alt="image" class="img-responsive" />
										</span>
										<div class="product_details">
											<span class="prod_size"><b>Work</b></span>
											<h4><b><?php echo $data['work_name']; ?></b></h4>
										</div>

									<td>
										<h4>₹ <?php echo $data['work_price']; ?></h4>
									</td>
						...
						<?php if (isset($_SESSION['cart_total'])) { ?>
							...
							?>
								<a href="special.php?my_id=<?php echo $_SESSION['uid'] ?>&cat_id=<?php echo $_SESSION['cat_id']; ?>" class="proceed_btn t_btn">Can U give Special Instruction?</a></center>
						<?php }
						}
						?>
					</div>
