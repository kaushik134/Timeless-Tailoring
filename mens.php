				...
				<div class="col-md-12 col-sm-12 col-xs-12">
					<div class="womens_section_wrap">
						<div class="row">
							...
							?>
							<!-- style show any types -->
							
							<?php if (isset($_GET['category_type']) || $_GET['category_type'] != "bottom") { ?>
								<a href="mens.php?cat_id=<?php echo $_GET['cat_id']; ?>&sub_cat_id=<?php echo $sub_cat_row['subcategory_id']; ?>&category_type=<?php echo $_GET['category_type']; ?>"
									class="sub-cat"><?php echo $sub_cat_row['subcategory_name']; ?></a>
							<?php } ?>
							...
							?>
							<?php if (isset($_GET['category_type']) || $_GET['category_type'] != "bottom") { ?>
								<a href="mens.php?cat_id=<?php echo $_GET['cat_id']; ?>&sub_cat_id=ado&category_type=<?php echo $_GET['category_type']; ?>"
									class="sub-cat">Add Ons</a>
							<?php } ?>

							<a href="cat_measurement.php?cat_id=<?php echo $_GET['cat_id']; ?>"
								class="sub-cat">MEASUREMENT</a>
											...
											<div class="col-md-4 col-sm-4 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
												<div class="fea_box">
													<div class="fea_box_img">
														<a href="" class="fea_overlay"><img style="height: 400px;width: 600px;"
																src="admin/profiles/<?php echo $result['style_image']; ?>" alt="image"
									...
									<div class="col-md-4 col-sm-4 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
										<div class="fea_box">
											<div class="fea_box_img">
												...
												<div class="fea_inner">
													<ul>
														...
														<li class="second_li"><a href="add_cart.php?cat_id=<?php echo $_GET['cat_id'] ?>&sub_cat_id=<?php if (isset($_GET['sub_cat_id'])) {
															   echo $_GET['sub_cat_id'];
														   } ?>&style_id=<?php echo $result['style_id']; ?>&category_type=<?php if (isset($_GET['category_type'])) {
																   echo $_GET['category_type'];
															   } ?>"><i class="fa fa-shopping-cart" aria-hidden="true"></i>
																<div class="toltip_div">
																	<p class="toltip">Add Cart</p>
																</div>
															</a></li>
											...
											<div class="fea_box_data">
												<h2><a >
														<?php echo $result['style_name']; ?>
													</a></h2>
												<div class="fea_reating">

												</div>
												<span>Rs.
													<?php echo $result['style_price']; ?>
												</span>
											</div>
										</div>
									</div>
									...
									<form action="add_cart.php" method="POST">
										...
										while ($lining_row = mysqli_fetch_array($ling_data)) {
											...
											<div class="col-md-4 col-sm-4 col-xs-12 w-100 wow fadeInUp" data-wow-delay="0.2s">
												<div class="fea_box">
													<div class="fea_box_img">
														<input type="radio" style="height:30px;width:30px" name="lining_id"
															value="<?php echo $lining_row['lining_id']; ?>">
														<a href="" class="fea_overlay"><img style="height: 400px;width: 600px;"
																src="admin/profiles/<?php echo $lining_row['lining_image']; ?>"
													...
													<div class="fea_box_data">
														<h2><a href="#">
																<?php echo $lining_row['lining_name']; ?>
															</a></h2>
														...
														<span>Rs.
															<?php echo $lining_row['lining_price']; ?>
														</span>
													</div>
												</div>
											</div>
