				  ...
				  <ul id="progressbar">
					...
					include_once('connect.php');
					 if(isset($_POST['stbn']))
					 	//echo $str; die;
					 {
					 	$qry="update customer_tbl set customer_name='".$_POST['name']."',email='".$_POST['email']."',contact='".$_POST['contact']."',address='".$_POST['address']."',city='".$_POST['city']."',pincode='".$_POST['pincode']."' where customer_id='".$_GET['my_id']."'";
					 	//echo $qry; die;
