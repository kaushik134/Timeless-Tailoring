...
$cart=1;
$status=1;
	$qry="insert into order_tbl values(NULL,'".$delivery_id."','".$_SESSION['customer_id']."','".$date."','".$status."')";
//die;
	...
	// echo "insert into payment_bill_tbl values(NULL,'online','".$_SESSION['cart_total']."','".$date."','".$time."','0')";
	 ...
	 $qury2=mysqli_query($cnn,"insert into payment_tbl values(NULL,'cash','".$_SESSION['cart_total']."','".$date."','".$time."','0')");
	...
	$time=date('His');
	 ...
	 $qury2=mysqli_query($cnn,"insert into payment_details_tbl values(NULL,'".$payment_id."','".$_SESSION['customer_id']."','".$order_id."','".$transaction_id."')");
...
//$order_status="1";
		for($i=0;$i<$len;$i++)
		{
			 ...
			 $qury1=mysqli_query($cnn,"insert into order_details_tbl values(NULL,'".$order_id."','".$cart_array[$i]."','0')");
