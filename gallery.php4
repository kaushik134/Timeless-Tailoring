...
<div class="main_section  gallery_section section_10">
	<div class="container">
		<div class="row">
			<div class="col-lg-12 col-xs-12 wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">
			...
			<div class="gallery_wrap">
				<div class="popup_gallery">
					<div class="img_grid"> 
						<div class="column">
							<div class="grid_itesms wow fadeInUp" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s;">
							...
							<div class="grid_itesms wow fadeInUp" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
		...
		<div class="pagination_wrap text-right wow fadeInRight" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
					...
					<div class="widget newsletter_widget margin_t_70">
						...
						<div class="textwidget">
							<div class="footer_newsletter_form">
								<form>
									<input type="email" name="f_email" id="f_email" placeholder="Enter Your Email" />
			...
			<div class="row">
				<div class="col-lg-12">
					<p class="copyright_text">
						Copyright &copy; 2021, All Rights Reserved by <a href="http://templatebundle.net/">Template Bundle</a>
					</p>
				</div>
			</div>
		</div>
